...
public class ModelTemplates {
    ...
    public static final ModelTemplate[] STEMS = (ModelTemplate[])IntStream.range((int)0, (int)8).mapToObj($$0 -> ModelTemplates.create("stem_growth" + $$0, "_stage" + $$0, TextureSlot.STEM)).toArray(ModelTemplate[]::new);
    ...
    private static ModelTemplate create(TextureSlot ... $$0) {
        return new ModelTemplate((Optional<ResourceLocation>)Optional.empty(), (Optional<String>)Optional.empty(), $$0);
    }

    private static ModelTemplate create(String $$0, TextureSlot ... $$1) {
        return new ModelTemplate((Optional<ResourceLocation>)Optional.of((Object)new ResourceLocation("minecraft", "block/" + $$0)), (Optional<String>)Optional.empty(), $$1);
    }

    private static ModelTemplate createItem(String $$0, TextureSlot ... $$1) {
        return new ModelTemplate((Optional<ResourceLocation>)Optional.of((Object)new ResourceLocation("minecraft", "item/" + $$0)), (Optional<String>)Optional.empty(), $$1);
    }

    private static ModelTemplate create(String $$0, String $$1, TextureSlot ... $$2) {
        return new ModelTemplate((Optional<ResourceLocation>)Optional.of((Object)new ResourceLocation("minecraft", "block/" + $$0)), (Optional<String>)Optional.of((Object)$$1), $$2);
    }
}