...
public class FeatureUtils {
    ...
    private static BlockPredicate simplePatchPredicate(List<Block> $$0) {
        BlockPredicate $$2;
        if (!$$0.isEmpty()) {
            BlockPredicate $$1 = BlockPredicate.allOf(BlockPredicate.ONLY_IN_AIR_PREDICATE, BlockPredicate.matchesBlocks(Direction.DOWN.getNormal(), $$0));
        } else {
    ...
    public static <FC extends FeatureConfiguration, F extends Feature<FC>> RandomPatchConfiguration simplePatchConfiguration(F $$0, FC $$1) {
        return FeatureUtils.simplePatchConfiguration($$0, $$1, (List<Block>)List.of(), 96);
    }

    public static ResourceKey<ConfiguredFeature<?, ?>> createKey(String $$0) {
        return ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation($$0));
    }
