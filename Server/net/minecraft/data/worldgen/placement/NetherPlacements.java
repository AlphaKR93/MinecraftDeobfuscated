...
public class NetherPlacements {
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> $$0) {
        ...
        PlacementUtils.register($$0, DELTA, $$2, CountOnEveryLayerPlacement.of(40), BiomeFilter.biome());
        PlacementUtils.register($$0, SMALL_BASALT_COLUMNS, $$3, CountOnEveryLayerPlacement.of(4), BiomeFilter.biome());
        PlacementUtils.register($$0, LARGE_BASALT_COLUMNS, $$4, CountOnEveryLayerPlacement.of(2), BiomeFilter.biome());
        PlacementUtils.register($$0, BASALT_BLOBS, $$5, CountPlacement.of(75), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome());
        PlacementUtils.register($$0, BLACKSTONE_BLOBS, $$6, CountPlacement.of(25), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome());
        PlacementUtils.register($$0, GLOWSTONE_EXTRA, $$7, CountPlacement.of(BiasedToBottomInt.of(0, 9)), InSquarePlacement.spread(), PlacementUtils.RANGE_4_4, BiomeFilter.biome());
        PlacementUtils.register($$0, GLOWSTONE, $$7, CountPlacement.of(10), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome());
        PlacementUtils.register($$0, CRIMSON_FOREST_VEGETATION, $$8, CountOnEveryLayerPlacement.of(6), BiomeFilter.biome());
        PlacementUtils.register($$0, WARPED_FOREST_VEGETATION, $$9, CountOnEveryLayerPlacement.of(5), BiomeFilter.biome());
        PlacementUtils.register($$0, NETHER_SPROUTS, $$10, CountOnEveryLayerPlacement.of(4), BiomeFilter.biome());
        PlacementUtils.register($$0, TWISTING_VINES, $$11, CountPlacement.of(10), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome());
        PlacementUtils.register($$0, WEEPING_VINES, $$12, CountPlacement.of(10), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome());
        PlacementUtils.register($$0, PATCH_CRIMSON_ROOTS, $$13, PlacementUtils.FULL_RANGE, BiomeFilter.biome());
        PlacementUtils.register($$0, BASALT_PILLAR, $$14, CountPlacement.of(10), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome());
        PlacementUtils.register($$0, SPRING_DELTA, $$15, CountPlacement.of(16), InSquarePlacement.spread(), PlacementUtils.RANGE_4_4, BiomeFilter.biome());
        PlacementUtils.register($$0, SPRING_CLOSED, $$16, CountPlacement.of(16), InSquarePlacement.spread(), PlacementUtils.RANGE_10_10, BiomeFilter.biome());
        PlacementUtils.register($$0, SPRING_CLOSED_DOUBLE, $$16, CountPlacement.of(32), InSquarePlacement.spread(), PlacementUtils.RANGE_10_10, BiomeFilter.biome());
        PlacementUtils.register($$0, SPRING_OPEN, $$17, CountPlacement.of(8), InSquarePlacement.spread(), PlacementUtils.RANGE_4_4, BiomeFilter.biome());
        ...
        PlacementUtils.register($$0, PATCH_SOUL_FIRE, $$18, (List<PlacementModifier>)$$20);
        PlacementUtils.register($$0, PATCH_FIRE, $$19, (List<PlacementModifier>)$$20);
    }
}