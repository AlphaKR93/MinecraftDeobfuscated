...
public enum ConnectionProtocol implements BundlerInfo.Provider
{
    ...
    public int getPacketId(PacketFlow $$0, Packet<?> $$1) {
        return ((PacketSet)this.flows.get((Object)$$0)).getId($$1.getClass());
    }

    @Override
    public BundlerInfo getBundlerInfo(PacketFlow $$0) {
        return ((PacketSet)this.flows.get((Object)$$0)).bundlerInfo();
    }
    ...
    public static ConnectionProtocol getProtocolForPacket(Packet<?> $$0) {
        return (ConnectionProtocol)PROTOCOL_BY_PACKET.get((Object)$$0.getClass());
    }
    ...
    static {
        ...
        for (ConnectionProtocol $$0 : ConnectionProtocol.values()) {
            ...
            $$0.flows.forEach(($$12, $$2) -> $$2.listAllPackets($$1 -> {
    ...
    static class PacketSet<T extends PacketListener> {
        ...
        public <P extends BundlePacket<T>> PacketSet<T> withBundlePacket(Class<P> $$0, Function<Iterable<Packet<T>>, P> $$12) {
            if (this.bundlerInfo != BundlerInfo.EMPTY) {
                throw new IllegalStateException("Bundle packet already configured");
            }
            BundleDelimiterPacket $$2 = new BundleDelimiterPacket();
            this.addPacket(BundleDelimiterPacket.class, $$1 -> $$2);
            this.bundlerInfo = BundlerInfo.createForPacket($$0, $$12, $$2);
            this.extraClasses.add($$0);
            return this;
        }

        public int getId(Class<?> $$0) {
            return this.classToId.getInt($$0);
        }
        ...
        public void listAllPackets(Consumer<Class<? extends Packet<?>>> $$02) {
            this.classToId.keySet().stream().filter($$0 -> $$0 != BundleDelimiterPacket.class).forEach($$02);
            this.extraClasses.forEach($$02);
        }
