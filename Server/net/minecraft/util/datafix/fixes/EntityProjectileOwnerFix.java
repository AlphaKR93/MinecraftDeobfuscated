...
extends DataFix {
    ...
    private Typed<?> updateProjectiles(Typed<?> $$0) {
        ...
        $$0 = this.updateEntity($$0, "minecraft:potion", this::updateItemPotion);
    ...
    private Dynamic<?> setUUID(Dynamic<?> $$0, long $$1, long $$2) {
        String $$3 = "OwnerUUID";
        if ($$1 != 0L && $$2 != 0L) {
            return $$0.set("OwnerUUID", $$0.createIntList(Arrays.stream((int[])EntityProjectileOwnerFix.createUUIDArray($$1, $$2))));
        }
        return $$0;
    }
