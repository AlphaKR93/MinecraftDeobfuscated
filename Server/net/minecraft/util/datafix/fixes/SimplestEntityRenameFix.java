...
extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        if (!Objects.equals((Object)this.getOutputSchema().getType(References.ENTITY_NAME), (Object)$$22)) {
        ...
        return TypeRewriteRule.seq((TypeRewriteRule)this.fixTypeEverywhere(this.name, (Type)$$0, (Type)$$1, $$2 -> $$22 -> $$22.mapFirst($$2 -> {
            ...
            Type $$5 = (Type)$$1.types().get((Object)$$3);
            if (!$$5.equals((Object)$$4, true, true)) {
                throw new IllegalStateException(String.format((Locale)Locale.ROOT, (String)"Dynamic type check failed: %s not equal to %s", (Object[])new Object[]{$$5, $$4}));
            }
            return $$3;
