...
extends DataFix {
    ...
    private static Dynamic<?> updateChunkTag(Dynamic<?> $$0, OptionalDynamic<?> $$1) {
        ...
        boolean $$2 = "minecraft:overworld".equals($$1.get("dimension").asString().result().orElse((Object)""));
        ...
        if ($$2 && $$3.isPresent()) {
            ...
            if (!STATUSES_TO_SKIP_BLENDING.contains((Object)$$4)) {
                $$0 = BlendingDataFix.updateBlendingData($$0, 384, -64);
            } else if ($$5.isPresent() && !STATUSES_TO_SKIP_BLENDING.contains((Object)($$7 = NamespacedSchema.ensureNamespaced(($$6 = (Dynamic)$$5.get()).get("target_status").asString("empty"))))) {
