...
implements ProfileCollector {
    private static final long WARNING_TIME_NANOS = Duration.ofMillis((long)100L).toNanos();
    ...
    public void push(String $$0) {
        ...
        this.paths.add((Object)this.path);
    ...
    public void markForCharting(MetricCategory $$0) {
        this.chartedPaths.add((Object)Pair.of((Object)this.path, (Object)((Object)$$0)));
    }
    ...
    public void pop() {
        ...
        ++$$3.count;
        $$3.maxDuration = Math.max((long)$$3.maxDuration, (long)$$2);
        $$3.minDuration = Math.min((long)$$3.minDuration, (long)$$2);
    ...
    private PathEntry getCurrentEntry() {
        if (this.currentEntry == null) {
            this.currentEntry = (PathEntry)this.entries.computeIfAbsent((Object)this.path, $$0 -> new PathEntry());
        }
    ...
    public void incrementCounter(Supplier<String> $$0, int $$1) {
        this.getCurrentEntry().counters.addTo((Object)((String)$$0.get()), (long)$$1);
    }
    ...
    public PathEntry getEntry(String $$0) {
        return (PathEntry)this.entries.get((Object)$$0);
    }
