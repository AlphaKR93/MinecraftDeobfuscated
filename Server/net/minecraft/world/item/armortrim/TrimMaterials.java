...
public class TrimMaterials {
    ...
    public static void nextUpdate(BootstapContext<TrimMaterial> $$0) {
        TrimMaterials.register($$0, QUARTZ, Items.QUARTZ, Style.EMPTY.withColor(14931140), 0.1f);
        TrimMaterials.register($$0, IRON, Items.IRON_INGOT, Style.EMPTY.withColor(0xECECEC), 0.2f, (Map<ArmorMaterials, String>)Map.of((Object)ArmorMaterials.IRON, (Object)"iron_darker"));
        TrimMaterials.register($$0, NETHERITE, Items.NETHERITE_INGOT, Style.EMPTY.withColor(6445145), 0.3f, (Map<ArmorMaterials, String>)Map.of((Object)ArmorMaterials.NETHERITE, (Object)"netherite_darker"));
        TrimMaterials.register($$0, REDSTONE, Items.REDSTONE, Style.EMPTY.withColor(9901575), 0.4f);
        TrimMaterials.register($$0, COPPER, Items.COPPER_INGOT, Style.EMPTY.withColor(11823181), 0.5f);
        TrimMaterials.register($$0, GOLD, Items.GOLD_INGOT, Style.EMPTY.withColor(14594349), 0.6f, (Map<ArmorMaterials, String>)Map.of((Object)ArmorMaterials.GOLD, (Object)"gold_darker"));
        TrimMaterials.register($$0, EMERALD, Items.EMERALD, Style.EMPTY.withColor(1155126), 0.7f);
        TrimMaterials.register($$0, DIAMOND, Items.DIAMOND, Style.EMPTY.withColor(7269586), 0.8f, (Map<ArmorMaterials, String>)Map.of((Object)ArmorMaterials.DIAMOND, (Object)"diamond_darker"));
        TrimMaterials.register($$0, LAPIS, Items.LAPIS_LAZULI, Style.EMPTY.withColor(4288151), 0.9f);
        TrimMaterials.register($$0, AMETHYST, Items.AMETHYST_SHARD, Style.EMPTY.withColor(10116294), 1.0f);
    }
    ...
    private static void register(BootstapContext<TrimMaterial> $$0, ResourceKey<TrimMaterial> $$1, Item $$2, Style $$3, float $$4) {
        TrimMaterials.register($$0, $$1, $$2, $$3, $$4, (Map<ArmorMaterials, String>)Map.of());
    }
    ...
    private static void register(BootstapContext<TrimMaterial> $$0, ResourceKey<TrimMaterial> $$1, Item $$2, Style $$3, float $$4, Map<ArmorMaterials, String> $$5) {
        TrimMaterial $$6 = TrimMaterial.create($$1.location().getPath(), $$2, $$4, Component.translatable(Util.makeDescriptionId("trim_material", $$1.location())).withStyle($$3), $$5);
        $$0.register($$1, $$6);
    }
