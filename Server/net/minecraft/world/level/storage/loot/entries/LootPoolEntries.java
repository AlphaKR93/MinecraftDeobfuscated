...
public class LootPoolEntries {
    ...
    private static LootPoolEntryType register(String $$0, Serializer<? extends LootPoolEntryContainer> $$1) {
        return Registry.register(BuiltInRegistries.LOOT_POOL_ENTRY_TYPE, new ResourceLocation($$0), new LootPoolEntryType($$1));
    }
