...
public class Node {
    ...
    public float distanceManhattan(Node $$0) {
        float $$1 = Math.abs((int)($$0.x - this.x));
        float $$2 = Math.abs((int)($$0.y - this.y));
        float $$3 = Math.abs((int)($$0.z - this.z));
        return $$1 + $$2 + $$3;
    }

    public float distanceManhattan(BlockPos $$0) {
        float $$1 = Math.abs((int)($$0.getX() - this.x));
        float $$2 = Math.abs((int)($$0.getY() - this.y));
        float $$3 = Math.abs((int)($$0.getZ() - this.z));
        return $$1 + $$2 + $$3;
    }
    ...
    protected static void readContents(FriendlyByteBuf $$0, Node $$1) {
        ...
        $$1.type = $$0.readEnum(BlockPathTypes.class);
        $$1.f = $$0.readFloat();
    }
}