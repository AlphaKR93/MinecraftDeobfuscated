...
extends Feature<Configuration> {
    ...
    public boolean place(FeaturePlaceContext<Configuration> $$0) {
        ...
        BlockState $$21 = $$4.fluid().getState($$3, (BlockPos)$$1);
        for (int $$22 = 0; $$22 < 16; ++$$22) {
            for (int $$23 = 0; $$23 < 16; ++$$23) {
                for (int $$24 = 0; $$24 < 8; ++$$24) {
                    ...
                    if (!$$25) continue;
                    Material $$26 = $$2.getBlockState(((BlockPos)$$1).offset($$22, $$24, $$23)).getMaterial();
                    if ($$24 >= 4 && $$26.isLiquid()) {
                        return false;
                    }
                    if ($$24 >= 4 || $$26.isSolid() || $$2.getBlockState(((BlockPos)$$1).offset($$22, $$24, $$23)) == $$21) continue;
                    return false;
                }
            }
        }
        for (int $$27 = 0; $$27 < 16; ++$$27) {
            for (int $$28 = 0; $$28 < 16; ++$$28) {
                for (int $$29 = 0; $$29 < 8; ++$$29) {
                    BlockPos $$30;
                    if (!$$5[($$27 * 16 + $$28) * 8 + $$29] || !this.canReplaceBlock($$2.getBlockState($$30 = ((BlockPos)$$1).offset($$27, $$29, $$28)))) continue;
                    boolean $$31 = $$29 >= 4;
        ...
        BlockState $$32 = $$4.barrier().getState($$3, (BlockPos)$$1);
        if (!$$32.isAir()) {
            for (int $$33 = 0; $$33 < 16; ++$$33) {
                for (int $$34 = 0; $$34 < 16; ++$$34) {
                    for (int $$35 = 0; $$35 < 8; ++$$35) {
                        ...
                        if (!$$36 || $$35 >= 4 && $$3.nextInt(2) == 0 || !($$37 = $$2.getBlockState(((BlockPos)$$1).offset($$33, $$35, $$34))).getMaterial().isSolid() || $$37.is(BlockTags.LAVA_POOL_STONE_CANNOT_REPLACE)) continue;
                        BlockPos $$38 = ((BlockPos)$$1).offset($$33, $$35, $$34);
                        $$2.setBlock($$38, $$32, 2);
        ...
        if ($$21.getFluidState().is(FluidTags.WATER)) {
            for (int $$39 = 0; $$39 < 16; ++$$39) {
                for (int $$40 = 0; $$40 < 16; ++$$40) {
                    int $$41 = 4;
                    BlockPos $$42 = ((BlockPos)$$1).offset($$39, 4, $$40);
                    if (!((Biome)$$2.getBiome($$42).value()).shouldFreeze($$2, $$42, false) || !this.canReplaceBlock($$2.getBlockState($$42))) continue;
