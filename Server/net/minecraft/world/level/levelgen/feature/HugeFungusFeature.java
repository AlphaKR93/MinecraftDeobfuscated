...
extends Feature<HugeFungusConfiguration> {
    ...
    private static boolean isReplaceable(LevelAccessor $$0, BlockPos $$12, boolean $$2) {
        return $$0.isStateAtPosition($$12, $$1 -> {
            Material $$2 = $$1.getMaterial();
            return $$1.canBeReplaced() || $$2 && $$2 == Material.PLANT;
        });
    }

    private void placeStem(LevelAccessor $$0, RandomSource $$1, HugeFungusConfiguration $$2, BlockPos $$3, int $$4, boolean $$5) {
        ...
        for (int $$9 = -$$8; $$9 <= $$8; ++$$9) {
            for (int $$10 = -$$8; $$10 <= $$8; ++$$10) {
                ...
                for (int $$12 = 0; $$12 < $$4; ++$$12) {
                    ...
                    if (!HugeFungusFeature.isReplaceable($$0, $$6, true)) continue;
                    if ($$2.planted) {
    ...
    private void placeHat(LevelAccessor $$0, RandomSource $$1, HugeFungusConfiguration $$2, BlockPos $$3, int $$4, boolean $$5) {
        int $$9;
        BlockPos.MutableBlockPos $$6 = new BlockPos.MutableBlockPos();
        boolean $$7 = $$2.hatState.is(Blocks.NETHER_WART_BLOCK);
        int $$8 = Math.min((int)($$1.nextInt(1 + $$4 / 3) + 5), (int)$$4);
        for (int $$10 = $$9 = $$4 - $$8; $$10 <= $$4; ++$$10) {
            ...
            for (int $$12 = -$$11; $$12 <= $$11; ++$$12) {
                for (int $$13 = -$$11; $$13 <= $$11; ++$$13) {
                    ...
                    if (!HugeFungusFeature.isReplaceable($$0, $$6, false)) continue;
    ...
    private void placeHatDropBlock(LevelAccessor $$0, RandomSource $$1, BlockPos $$2, BlockState $$3, boolean $$4) {
        if ($$0.getBlockState((BlockPos)$$2.below()).is($$3.getBlock())) {
            this.setBlock($$0, $$2, $$3);
