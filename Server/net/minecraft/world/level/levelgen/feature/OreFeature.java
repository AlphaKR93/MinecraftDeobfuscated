    ...
    protected boolean doPlace(WorldGenLevel $$0, RandomSource $$1, OreConfiguration $$2, double $$3, double $$4, double $$5, double $$6, double $$7, double $$8, int $$9, int $$10, int $$11, int $$12, int $$13) {
        ...
        try (BulkSectionAccess $$32 = new BulkSectionAccess($$0);){
            for (int $$33 = 0; $$33 < $$17; ++$$33) {
                ...
                double $$36 = $$18[$$33 * 4 + 1];
                double $$37 = $$18[$$33 * 4 + 2];
                int $$38 = Math.max((int)Mth.floor($$35 - $$34), (int)$$9);
                int $$39 = Math.max((int)Mth.floor($$36 - $$34), (int)$$10);
                int $$40 = Math.max((int)Mth.floor($$37 - $$34), (int)$$11);
                int $$41 = Math.max((int)Mth.floor($$35 + $$34), (int)$$38);
                int $$42 = Math.max((int)Mth.floor($$36 + $$34), (int)$$39);
                int $$43 = Math.max((int)Mth.floor($$37 + $$34), (int)$$40);
                    ...
                    for (int $$46 = $$39; $$46 <= $$42; ++$$46) {
                        ...
                        block11: for (int $$48 = $$40; $$48 <= $$43; ++$$48) {
                            ...
                            for (OreConfiguration.TargetBlockState $$56 : $$2.targetStates) {
                                if (!OreFeature.canPlaceOre($$55, (Function<BlockPos, BlockState>)((Function)$$32::getBlockState), $$1, $$2, $$56, $$16)) continue;
