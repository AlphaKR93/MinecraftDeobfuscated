...
extends FoliagePlacer {
    public static final Codec<RandomSpreadFoliagePlacer> CODEC = RecordCodecBuilder.create($$02 -> RandomSpreadFoliagePlacer.foliagePlacerParts($$02).and($$02.group((App)IntProvider.codec(1, 512).fieldOf("foliage_height").forGetter($$0 -> $$0.foliageHeight), (App)Codec.intRange((int)0, (int)256).fieldOf("leaf_placement_attempts").forGetter($$0 -> $$0.leafPlacementAttempts))).apply((Applicative)$$02, RandomSpreadFoliagePlacer::new));
