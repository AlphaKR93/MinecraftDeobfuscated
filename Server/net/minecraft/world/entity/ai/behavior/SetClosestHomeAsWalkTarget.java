...
public class SetClosestHomeAsWalkTarget {
    ...
    private static /* synthetic */ App lambda$create$6(MutableLong $$0, Long2LongMap $$1, float $$2, BehaviorBuilder.Instance $$32) {
        return $$32.group($$32.absent(MemoryModuleType.WALK_TARGET), $$32.absent(MemoryModuleType.HOME)).apply((Applicative)$$32, ($$3, $$42) -> ($$4, $$5, $$6) -> {
            ...
            Optional<BlockPos> $$8 = $$7.findClosest((Predicate<Holder<PoiType>>)((Predicate)$$0 -> $$0.is(PoiTypes.HOME)), $$5.blockPosition(), 48, PoiManager.Occupancy.ANY);
            ...
            Set $$11 = (Set)$$7.findAllWithType((Predicate<Holder<PoiType>>)((Predicate)$$0 -> $$0.is(PoiTypes.HOME)), (Predicate<BlockPos>)$$10, $$5.blockPosition(), 48, PoiManager.Occupancy.ANY).collect(Collectors.toSet());
            Path $$122 = AcquirePoi.findPathToPois($$5, (Set<Pair<Holder<PoiType>, BlockPos>>)$$11);
