...
public class BehaviorUtils {
    ...
    public static void lockGazeAndWalkToEachOther(LivingEntity $$0, LivingEntity $$1, float $$2) {
        ...
        BehaviorUtils.setWalkAndLookTargetMemoriesToEachOther($$0, $$1, $$2);
    }
    ...
    public static boolean targetIsValid(Brain<?> $$0, MemoryModuleType<? extends LivingEntity> $$12, EntityType<?> $$2) {
        return BehaviorUtils.targetIsValid($$0, $$12, (Predicate<LivingEntity>)((Predicate)$$1 -> $$1.getType() == $$2));
    }
    ...
    private static void setWalkAndLookTargetMemoriesToEachOther(LivingEntity $$0, LivingEntity $$1, float $$2) {
        int $$3 = 2;
        BehaviorUtils.setWalkAndLookTargetMemories($$0, $$1, $$2, 2);
        BehaviorUtils.setWalkAndLookTargetMemories($$1, $$0, $$2, 2);
    }
    ...
    public static SectionPos findSectionClosestToVillage(ServerLevel $$0, SectionPos $$1, int $$22) {
        ...
        return (SectionPos)SectionPos.cube($$1, $$22).filter($$2 -> $$0.sectionsToVillage((SectionPos)$$2) < $$3).min(Comparator.comparingInt($$0::sectionsToVillage)).orElse((Object)$$1);
    }
    ...
    public static boolean canSee(LivingEntity $$0, LivingEntity $$1) {
        ...
        return ((NearestVisibleLivingEntities)$$2.getMemory(MemoryModuleType.NEAREST_VISIBLE_LIVING_ENTITIES).get()).contains($$1);
    }
    ...
    public static LivingEntity getNearestTarget(LivingEntity $$0, Optional<LivingEntity> $$1, LivingEntity $$2) {
        ...
        return BehaviorUtils.getTargetNearestMe($$0, (LivingEntity)$$1.get(), $$2);
    }
    ...
    public static Optional<LivingEntity> getLivingEntityFromUUIDMemory(LivingEntity $$02, MemoryModuleType<UUID> $$12) {
        ...
        return $$2.map($$1 -> ((ServerLevel)$$0.level).getEntity((UUID)$$1)).map($$0 -> {
            LivingEntity $$1;
    ...
    public static Vec3 getRandomSwimmablePos(PathfinderMob $$0, int $$1, int $$2) {
        ...
        int $$4 = 0;
        while ($$3 != null && !$$0.level.getBlockState(new BlockPos($$3)).isPathfindable($$0.level, new BlockPos($$3), PathComputationType.WATER) && $$4++ < 10) {
