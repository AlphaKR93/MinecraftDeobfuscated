...
extends Goal {
    ...
    public void tick() {
        ...
        if (--this.attackTime == 0) {
            ...
            float $$2 = (float)Math.sqrt((double)$$0) / this.attackRadius;
            ...
            this.attackTime = Mth.floor(Mth.lerp(Math.sqrt((double)$$0) / (double)this.attackRadius, (double)this.attackIntervalMin, (double)this.attackIntervalMax));
        }
    }
}