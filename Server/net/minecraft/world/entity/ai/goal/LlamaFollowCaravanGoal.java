...
extends Goal {
    ...
    public boolean canUse() {
        ...
        List<Entity> $$02 = this.llama.level.getEntities(this.llama, this.llama.getBoundingBox().inflate(9.0, 4.0, 9.0), (Predicate<? super Entity>)((Predicate)$$0 -> {
    ...
    public void tick() {
        ...
        float $$2 = 2.0f;
        Vec3 $$3 = new Vec3($$0.getX() - this.llama.getX(), $$0.getY() - this.llama.getY(), $$0.getZ() - this.llama.getZ()).normalize().scale(Math.max((double)($$1 - 2.0), (double)0.0));
