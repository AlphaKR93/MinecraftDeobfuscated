...
extends Sensor<Mob> {
    ...
    protected void doTick(ServerLevel $$02, Mob $$1) {
        ...
        Set $$4 = (Set)$$2.findAllWithType((Predicate<Holder<PoiType>>)((Predicate)$$0 -> $$0.is(PoiTypes.HOME)), (Predicate<BlockPos>)($$3 = $$0 -> {
            long $$1 = $$0.asLong();
        ...
        Path $$5 = AcquirePoi.findPathToPois($$1, (Set<Pair<Holder<PoiType>, BlockPos>>)$$4);
