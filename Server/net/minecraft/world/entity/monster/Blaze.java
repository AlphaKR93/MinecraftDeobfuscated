...
extends Monster {
    ...
    protected void customServerAiStep() {
        ...
        if (($$0 = this.getTarget()) != null && $$0.getEyeY() > this.getEyeY() + (double)this.allowedHeightOffset && this.canAttack($$0)) {
            Vec3 $$1 = this.getDeltaMovement();
            this.setDeltaMovement(this.getDeltaMovement().add(0.0, ((double)0.3f - $$1.y) * (double)0.3f, 0.0));
        ...
        public void tick() {
            ...
            if ($$2 < 4.0) {
                ...
                if (this.attackTime <= 0) {
                    ...
                    if (this.attackStep > 1) {
                        double $$6 = Math.sqrt((double)Math.sqrt((double)$$2)) * 0.5;
                        if (!this.blaze.isSilent()) {
                            this.blaze.level.levelEvent(null, 1018, this.blaze.blockPosition(), 0);
                        }
                        for (int $$7 = 0; $$7 < 1; ++$$7) {
                            SmallFireball $$8 = new SmallFireball(this.blaze.level, this.blaze, this.blaze.getRandom().triangle($$3, 2.297 * $$6), $$4, this.blaze.getRandom().triangle($$5, 2.297 * $$6));
