...
public class Containers {
    ...
    public static void dropItemStack(Level $$0, double $$1, double $$2, double $$3, ItemStack $$4) {
        ...
        double $$6 = 1.0 - $$5;
        double $$7 = $$5 / 2.0;
        double $$8 = Math.floor((double)$$1) + $$0.random.nextDouble() * $$6 + $$7;
        double $$9 = Math.floor((double)$$2) + $$0.random.nextDouble() * $$6;
        double $$10 = Math.floor((double)$$3) + $$0.random.nextDouble() * $$6 + $$7;
        while (!$$4.isEmpty()) {
