...
extends SimpleCriterionTrigger<TriggerInstance> {
    ...
    public TriggerInstance createInstance(JsonObject $$0, EntityPredicate.Composite $$1, DeserializationContext $$2) {
        return new TriggerInstance($$1, ItemPredicate.fromJson($$0.get("item")));
    }
    ...
    extends AbstractCriterionTriggerInstance {
        ...
        public static TriggerInstance usedItem(ItemPredicate $$0) {
            return new TriggerInstance(EntityPredicate.Composite.ANY, $$0);
        }

        public static TriggerInstance usedItem(ItemLike $$0) {
            return new TriggerInstance(EntityPredicate.Composite.ANY, new ItemPredicate(null, (Set<Item>)ImmutableSet.of((Object)$$0.asItem()), MinMaxBounds.Ints.ANY, MinMaxBounds.Ints.ANY, EnchantmentPredicate.NONE, EnchantmentPredicate.NONE, null, NbtPredicate.ANY));
        }
