...
implements Comparable<Vec3i> {
    public static final Codec<Vec3i> CODEC = Codec.INT_STREAM.comapFlatMap($$02 -> Util.fixedSize($$02, 3).map($$0 -> new Vec3i($$0[0], $$0[1], $$0[2])), $$0 -> IntStream.of((int[])new int[]{$$0.getX(), $$0.getY(), $$0.getZ()}));
    ...
    public Vec3i(double $$0, double $$1, double $$2) {
    ...
    public Vec3i offset(double $$0, double $$1, double $$2) {
        if ($$0 == 0.0 && $$1 == 0.0 && $$2 == 0.0) {
            return this;
        }
        return new Vec3i((double)this.getX() + $$0, (double)this.getY() + $$1, (double)this.getZ() + $$2);
    }
    ...
    public int distManhattan(Vec3i $$0) {
        float $$1 = Math.abs((int)($$0.getX() - this.getX()));
        float $$2 = Math.abs((int)($$0.getY() - this.getY()));
        float $$3 = Math.abs((int)($$0.getZ() - this.getZ()));
        return (int)($$1 + $$2 + $$3);
    }
