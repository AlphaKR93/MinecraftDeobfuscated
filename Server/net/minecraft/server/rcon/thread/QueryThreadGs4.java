...
extends GenericThread {
    ...
    private QueryThreadGs4(ServerInterface $$0, int $$1) {
        ...
        this.hostIp = "0.0.0.0";
        if (this.serverIp.isEmpty() || this.hostIp.equals((Object)this.serverIp)) {
            ...
            try {
                ...
                LOGGER.warn("Unable to determine local host IP, please set server-ip in server.properties", (Throwable)$$3);
            }
        } else {
    ...
    private boolean processPacket(DatagramPacket $$0) throws IOException {
        ...
        switch ($$1[2]) {
            ...
            case 0: {
                ...
                $$4.writeString(Integer.toString((int)this.serverInterface.getPlayerCount()));
                $$4.writeString(Integer.toString((int)this.maxPlayers));
    ...
    private byte[] buildRuleResponse(DatagramPacket $$0) throws IOException {
        ...
        this.rulesResponse.write(0);
        for (String $$5 : $$4 = this.serverInterface.getPlayerNames()) {
    ...
    private byte[] getIdentBytes(SocketAddress $$0) {
        return ((RequestChallenge)this.validChallenges.get((Object)$$0)).getIdentBytes();
    }

    private Boolean validChallenge(DatagramPacket $$0) {
        SocketAddress $$1 = $$0.getSocketAddress();
        if (!this.validChallenges.containsKey((Object)$$1)) {
            return false;
        }
        byte[] $$2 = $$0.getData();
        return ((RequestChallenge)this.validChallenges.get((Object)$$1)).getChallenge() == PktUtils.intFromNetworkByteArray($$2, 7, $$0.getLength());
    }

    private void sendChallenge(DatagramPacket $$0) throws IOException {
        RequestChallenge $$1 = new RequestChallenge($$0);
        this.validChallenges.put((Object)$$0.getSocketAddress(), (Object)$$1);
        ...
        try {
            while (this.running) {
                try {
                    ...
                    this.recoverSocketError((Exception)$$2);
                }
            }
        }
        finally {
    ...
    private void recoverSocketError(Exception $$0) {
        ...
        LOGGER.warn("Unexpected exception", (Throwable)$$0);
        if (!this.initSocket()) {
    ...
    private boolean initSocket() {
        try {
            this.socket = new DatagramSocket(this.port, InetAddress.getByName((String)this.serverIp));
    ...
    static class RequestChallenge {
        ...
        public RequestChallenge(DatagramPacket $$0) {
            ...
            this.challengeBytes = String.format((Locale)Locale.ROOT, (String)"\t%s%d\u0000", (Object[])new Object[]{this.ident, this.challenge}).getBytes(StandardCharsets.UTF_8);
        }
