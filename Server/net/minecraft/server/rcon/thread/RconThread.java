...
extends GenericThread {
        ...
        try {
            while (this.running) {
                try {
                    ...
                    LOGGER.info("IO exception: ", (Throwable)$$3);
                }
            }
        }
        finally {
    ...
    public static RconThread create(ServerInterface $$0) {
        ...
        try {
            ServerSocket $$5 = new ServerSocket($$3, 0, InetAddress.getByName((String)$$2));
            $$5.setSoTimeout(500);
    ...
    private void closeSocket(ServerSocket $$0) {
        ...
        try {
            ...
            LOGGER.warn("Failed to close socket", (Throwable)$$1);
        }
    }
}