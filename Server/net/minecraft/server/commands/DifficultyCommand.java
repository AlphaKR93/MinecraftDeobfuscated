...
public class DifficultyCommand {
    private static final DynamicCommandExceptionType ERROR_ALREADY_DIFFICULT = new DynamicCommandExceptionType($$0 -> Component.translatable("commands.difficulty.failure", $$0));
    ...
    public static void register(CommandDispatcher<CommandSourceStack> $$02) {
        ...
        $$02.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)$$12.requires($$0 -> $$0.hasPermission(2))).executes($$0 -> {
            Difficulty $$1 = ((CommandSourceStack)$$0.getSource()).getLevel().getDifficulty();
            ((CommandSourceStack)$$0.getSource()).sendSuccess(Component.translatable("commands.difficulty.query", $$1.getDisplayName()), false);
            return $$1.getId();
        }));
    }
