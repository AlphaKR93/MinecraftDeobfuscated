...
public class SetSpawnCommand {
    ...
    private static int setSpawn(CommandSourceStack $$0, Collection<ServerPlayer> $$1, BlockPos $$2, float $$3) {
        ...
        if ($$1.size() == 1) {
            $$0.sendSuccess(Component.translatable("commands.spawnpoint.success.single", $$2.getX(), $$2.getY(), $$2.getZ(), Float.valueOf((float)$$3), $$6, ((ServerPlayer)((Object)$$1.iterator().next())).getDisplayName()), true);
        } else {
