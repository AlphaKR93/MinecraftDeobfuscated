...
public class TeamMsgCommand {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> $$02) {
        LiteralCommandNode $$1 = $$02.register((LiteralArgumentBuilder)Commands.literal("teammsg").then(Commands.argument("message", MessageArgument.message()).executes($$0 -> {
            ...
            PlayerTeam $$3 = (PlayerTeam)$$22.getTeam();
            if ($$3 == null) {
                throw ERROR_NOT_ON_TEAM.create();
            }
            List $$42 = $$1.getServer().getPlayerList().getPlayers().stream().filter($$2 -> $$2 == $$22 || $$2.getTeam() == $$3).toList();
            if (!$$42.isEmpty()) {
                MessageArgument.resolveChatMessage((CommandContext<CommandSourceStack>)$$0, "message", (Consumer<PlayerChatMessage>)((Consumer)$$4 -> TeamMsgCommand.sendMessage($$1, $$22, $$3, (List<ServerPlayer>)$$42, $$4)));
            }
            return $$42.size();
        })));
