...
public class WorldBorderCommand {
    ...
    private static int setDamageBuffer(CommandSourceStack $$0, float $$1) throws CommandSyntaxException {
        ...
        $$0.sendSuccess(Component.translatable("commands.worldborder.damage.buffer.success", String.format((Locale)Locale.ROOT, (String)"%.2f", (Object[])new Object[]{Float.valueOf((float)$$1)})), true);
        return (int)$$1;
    }
    ...
    private static int setDamageAmount(CommandSourceStack $$0, float $$1) throws CommandSyntaxException {
        ...
        $$0.sendSuccess(Component.translatable("commands.worldborder.damage.amount.success", String.format((Locale)Locale.ROOT, (String)"%.2f", (Object[])new Object[]{Float.valueOf((float)$$1)})), true);
        return (int)$$1;
    }
    ...
    private static int getSize(CommandSourceStack $$0) {
        ...
        $$0.sendSuccess(Component.translatable("commands.worldborder.get", String.format((Locale)Locale.ROOT, (String)"%.0f", (Object[])new Object[]{$$1})), false);
    ...
    private static int setCenter(CommandSourceStack $$0, Vec2 $$1) throws CommandSyntaxException {
        ...
        if ((double)Math.abs((float)$$1.x) > 2.9999984E7 || (double)Math.abs((float)$$1.y) > 2.9999984E7) {
            throw ERROR_TOO_FAR_OUT.create();
        }
        $$2.setCenter($$1.x, $$1.y);
        $$0.sendSuccess(Component.translatable("commands.worldborder.center.success", String.format((Locale)Locale.ROOT, (String)"%.2f", (Object[])new Object[]{Float.valueOf((float)$$1.x)}), String.format((Locale)Locale.ROOT, (String)"%.2f", (Object[])new Object[]{Float.valueOf((float)$$1.y)})), true);
        return 0;
    }
    ...
    private static int setSize(CommandSourceStack $$0, double $$1, long $$2) throws CommandSyntaxException {
        ...
        if ($$2 > 0L) {
            ...
            if ($$1 > $$4) {
                $$0.sendSuccess(Component.translatable("commands.worldborder.set.grow", String.format((Locale)Locale.ROOT, (String)"%.1f", (Object[])new Object[]{$$1}), Long.toString((long)($$2 / 1000L))), true);
            } else {
                $$0.sendSuccess(Component.translatable("commands.worldborder.set.shrink", String.format((Locale)Locale.ROOT, (String)"%.1f", (Object[])new Object[]{$$1}), Long.toString((long)($$2 / 1000L))), true);
            }
        } else {
            $$3.setSize($$1);
            $$0.sendSuccess(Component.translatable("commands.worldborder.set.immediate", String.format((Locale)Locale.ROOT, (String)"%.1f", (Object[])new Object[]{$$1})), true);
        }
        return (int)($$1 - $$4);
    }
}