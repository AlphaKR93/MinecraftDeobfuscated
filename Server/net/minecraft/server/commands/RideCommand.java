...
public class RideCommand {
    private static final DynamicCommandExceptionType ERROR_NOT_RIDING = new DynamicCommandExceptionType($$0 -> Component.translatable("commands.ride.not_riding", $$0));
    private static final Dynamic2CommandExceptionType ERROR_ALREADY_RIDING = new Dynamic2CommandExceptionType(($$0, $$1) -> Component.translatable("commands.ride.already_riding", $$0, $$1));
    private static final Dynamic2CommandExceptionType ERROR_MOUNT_FAILED = new Dynamic2CommandExceptionType(($$0, $$1) -> Component.translatable("commands.ride.mount.failure.generic", $$0, $$1));
    ...
    public static void register(CommandDispatcher<CommandSourceStack> $$02) {
        $$02.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("ride").requires($$0 -> $$0.hasPermission(2))).then(((RequiredArgumentBuilder)Commands.argument("target", EntityArgument.entity()).then(Commands.literal("mount").then(Commands.argument("vehicle", EntityArgument.entity()).executes($$0 -> RideCommand.mount((CommandSourceStack)$$0.getSource(), EntityArgument.getEntity((CommandContext<CommandSourceStack>)$$0, "target"), EntityArgument.getEntity((CommandContext<CommandSourceStack>)$$0, "vehicle")))))).then(Commands.literal("dismount").executes($$0 -> RideCommand.dismount((CommandSourceStack)$$0.getSource(), EntityArgument.getEntity((CommandContext<CommandSourceStack>)$$0, "target"))))));
    }
    ...
    private static int mount(CommandSourceStack $$0, Entity $$12, Entity $$2) throws CommandSyntaxException {
        ...
        $$0.sendSuccess(Component.translatable("commands.ride.mount.success", $$12.getDisplayName(), $$2.getDisplayName()), true);
        return 1;
    }
