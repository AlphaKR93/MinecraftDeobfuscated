...
public class WeatherCommand {
    ...
    private static int getDuration(CommandSourceStack $$0, int $$1, IntProvider $$2) {
        if ($$1 == -1) {
            return $$2.sample($$0.getLevel().getRandom());
        }
        return $$1;
    }

    private static int setClear(CommandSourceStack $$0, int $$1) {
        $$0.getLevel().setWeatherParameters(WeatherCommand.getDuration($$0, $$1, ServerLevel.RAIN_DELAY), 0, false, false);
    ...
    private static int setRain(CommandSourceStack $$0, int $$1) {
        $$0.getLevel().setWeatherParameters(0, WeatherCommand.getDuration($$0, $$1, ServerLevel.RAIN_DURATION), true, false);
    ...
    private static int setThunder(CommandSourceStack $$0, int $$1) {
        $$0.getLevel().setWeatherParameters(0, WeatherCommand.getDuration($$0, $$1, ServerLevel.THUNDER_DURATION), true, true);
