...
extends Monster {
    ...
    protected void registerGoals() {
        ...
        $$0.setFlags((EnumSet<Goal.Flag>)EnumSet.of((Enum)Goal.Flag.MOVE, (Enum)Goal.Flag.LOOK));
        ...
        if (this.isAlive()) {
            if (this.level.isClientSide) {
                ...
                if (!this.isInWater()) {
                    ...
                    this.clientSideTouchedGround = $$0.y < 0.0 && this.level.loadedAndEntityCanStandOn((BlockPos)this.blockPosition().below(), this);
                } else {
    ...
    public static boolean checkGuardianSpawnRules(EntityType<? extends Guardian> $$0, LevelAccessor $$1, MobSpawnType $$2, BlockPos $$3, RandomSource $$4) {
        return !($$4.nextInt(20) != 0 && $$1.canSeeSkyFromBelowWater($$3) || $$1.getDifficulty() == Difficulty.PEACEFUL || $$2 != MobSpawnType.SPAWNER && !$$1.getFluidState($$3).is(FluidTags.WATER) || !$$1.getFluidState((BlockPos)$$3.below()).is(FluidTags.WATER));
    }
    ...
    extends MoveControl {
        ...
        public void tick() {
            ...
            double $$8 = Math.sin((double)((double)(this.guardian.tickCount + this.guardian.getId()) * 0.5)) * 0.05;
            double $$9 = Math.cos((double)(this.guardian.getYRot() * ((float)Math.PI / 180)));
            double $$10 = Math.sin((double)(this.guardian.getYRot() * ((float)Math.PI / 180)));
            double $$11 = Math.sin((double)((double)(this.guardian.tickCount + this.guardian.getId()) * 0.75)) * 0.05;
    ...
    extends Goal {
        ...
        public void tick() {
            ...
            if (this.attackTime == 0) {
                ...
                $$0.hurt(DamageSource.indirectMagic(this.guardian, this.guardian), $$1);
                $$0.hurt(DamageSource.mobAttack(this.guardian), (float)this.guardian.getAttributeValue(Attributes.ATTACK_DAMAGE));
                this.guardian.setTarget(null);
            }
            super.tick();
        }
