...
public class AngerManagement {
    ...
    public static Codec<AngerManagement> codec(Predicate<Entity> $$0) {
        return RecordCodecBuilder.create($$12 -> $$12.group((App)SUSPECT_ANGER_PAIR.listOf().fieldOf("suspects").orElse((Object)Collections.emptyList()).forGetter(AngerManagement::createUuidAngerPairs)).apply((Applicative)$$12, $$1 -> new AngerManagement($$0, (List<Pair<UUID, Integer>>)$$1)));
    }
    ...
    private List<Pair<UUID, Integer>> createUuidAngerPairs() {
        return (List)Streams.concat((Stream[])new Stream[]{this.suspects.stream().map($$0 -> Pair.of((Object)$$0.getUUID(), (Object)this.angerBySuspect.getInt($$0))), this.angerByUuid.object2IntEntrySet().stream().map($$0 -> Pair.of((Object)((UUID)$$0.getKey()), (Object)$$0.getIntValue()))}).collect(Collectors.toList());
    }
    ...
    public void tick(ServerLevel $$0, Predicate<Entity> $$1) {
        ...
        while ($$5.hasNext()) {
            ...
            if ($$7 <= 1 || !$$1.test((Object)$$8) || $$9 != null) {
                this.suspects.remove((Object)$$8);
                $$5.remove();
    ...
    private void sortAndUpdateHighestAnger() {
        this.highestAnger = 0;
        this.suspects.sort((Comparator)this.suspectSorter);
    ...
    public int increaseAnger(Entity $$0, int $$12) {
        ...
        int $$3 = this.angerBySuspect.computeInt((Object)$$0, ($$1, $$2) -> Math.min((int)150, (int)(($$2 == null ? 0 : $$2) + $$12)));
        if ($$22) {
            int $$4 = this.angerByUuid.removeInt((Object)$$0.getUUID());
            this.angerBySuspect.put((Object)$$0, $$3 += $$4);
            this.suspects.add((Object)$$0);
        }
        this.sortAndUpdateHighestAnger();
        return $$3;
    }
    ...
    public Optional<LivingEntity> getActiveEntity() {
        return Optional.ofNullable((Object)this.getTopSuspect()).filter($$0 -> $$0 instanceof LivingEntity).map($$0 -> (LivingEntity)$$0);
    }
    ...
    protected record Sorter(AngerManagement angerManagement) implements Comparator<Entity>
    {
        public int compare(Entity $$0, Entity $$1) {
            ...
            this.angerManagement.highestAnger = Math.max((int)this.angerManagement.highestAnger, (int)Math.max((int)$$2, (int)$$3));
            ...
            return Integer.compare((int)$$3, (int)$$2);
        }
    }
}