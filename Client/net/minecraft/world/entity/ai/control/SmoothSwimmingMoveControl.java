...
extends MoveControl {
    ...
    public void tick() {
        ...
        if (this.mob.isInWater()) {
            ...
            double $$6 = Math.sqrt((double)($$0 * $$0 + $$2 * $$2));
            if (Math.abs((double)$$1) > (double)1.0E-5f || Math.abs((double)$$6) > (double)1.0E-5f) {
                float $$7 = -((float)(Mth.atan2($$1, $$6) * 57.2957763671875));
                $$7 = Mth.clamp(Mth.wrapDegrees($$7), (float)(-this.maxTurnX), (float)this.maxTurnX);
                this.mob.setXRot(this.rotlerp(this.mob.getXRot(), $$7, 5.0f));
            }
            ...
            float $$10 = Math.abs((float)Mth.wrapDegrees(this.mob.getYRot() - $$4));
