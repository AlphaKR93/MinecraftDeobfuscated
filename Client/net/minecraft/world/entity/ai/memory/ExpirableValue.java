...
public class ExpirableValue<T> {
    ...
    public static <T> Codec<ExpirableValue<T>> codec(Codec<T> $$0) {
        return RecordCodecBuilder.create($$12 -> $$12.group((App)$$0.fieldOf("value").forGetter($$0 -> $$0.value), (App)Codec.LONG.optionalFieldOf("ttl").forGetter($$0 -> $$0.canExpire() ? Optional.of((Object)$$0.timeToLive) : Optional.empty())).apply((Applicative)$$12, ($$0, $$1) -> new ExpirableValue<Object>($$0, (Long)$$1.orElse((Object)Long.MAX_VALUE))));
    }
}