...
public class PoiCompetitorScan {
    public static BehaviorControl<Villager> create() {
        return BehaviorBuilder.create($$0 -> $$0.group($$0.present(MemoryModuleType.JOB_SITE), $$0.present(MemoryModuleType.NEAREST_LIVING_ENTITIES)).apply((Applicative)$$0, ($$1, $$2) -> ($$3, $$42, $$5) -> {
            ...
            $$3.getPoiManager().getType($$6.pos()).ifPresent($$4 -> ((List)$$0.get($$2)).stream().filter($$1 -> $$1 instanceof Villager && $$1 != $$42).map($$0 -> (Villager)$$0).filter(LivingEntity::isAlive).filter($$2 -> PoiCompetitorScan.competesForSameJobsite($$6, $$4, $$2)).reduce((Object)$$42, PoiCompetitorScan::selectWinner));
            return true;
        }));
    }
    ...
    private static boolean competesForSameJobsite(GlobalPos $$0, Holder<PoiType> $$1, Villager $$2) {
        ...
        return $$3.isPresent() && $$0.equals($$3.get()) && PoiCompetitorScan.hasMatchingProfession($$1, $$2.getVillagerData().getProfession());
    }

    private static boolean hasMatchingProfession(Holder<PoiType> $$0, VillagerProfession $$1) {
        return $$1.heldJobSite().test($$0);
    }
}