...
public class GoToClosestVillage {
    public static BehaviorControl<Villager> create(float $$0, int $$1) {
        return BehaviorBuilder.create($$22 -> $$22.group($$22.absent(MemoryModuleType.WALK_TARGET)).apply((Applicative)$$22, $$2 -> ($$3, $$4, $$5) -> {
            ...
            Vec3 $$8 = null;
            for (int $$9 = 0; $$9 < 5; ++$$9) {
                Vec3 $$10 = LandRandomPos.getPos($$4, 15, 7, (ToDoubleFunction<BlockPos>)((ToDoubleFunction)$$1 -> -$$6.sectionsToVillage(SectionPos.of($$1))));
                if ($$10 == null) continue;
                int $$11 = $$6.sectionsToVillage(SectionPos.of(new BlockPos($$10)));
                if ($$11 < $$7) {
                    $$8 = $$10;
                    break;
                }
