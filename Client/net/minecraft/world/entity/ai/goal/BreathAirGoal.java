...
extends Goal {
    ...
    private void findAirPosition() {
        ...
        if ($$1 == null) {
            $$1 = new BlockPos(this.mob.getX(), this.mob.getY() + 8.0, this.mob.getZ());
        }
    ...
    private boolean givesAir(LevelReader $$0, BlockPos $$1) {
        ...
        return ($$0.getFluidState($$1).isEmpty() || $$2.is(Blocks.BUBBLE_COLUMN)) && $$2.isPathfindable($$0, $$1, PathComputationType.LAND);
    }
}