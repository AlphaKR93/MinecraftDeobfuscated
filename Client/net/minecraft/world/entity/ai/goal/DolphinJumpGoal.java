...
extends JumpGoal {
    ...
    private boolean waterIsClear(BlockPos $$0, int $$1, int $$2, int $$3) {
        ...
        return this.dolphin.level.getFluidState($$4).is(FluidTags.WATER) && !this.dolphin.level.getBlockState($$4).getMaterial().blocksMotion();
    }
    ...
    public boolean canContinueToUse() {
        ...
        return !($$0 * $$0 < (double)0.03f && this.dolphin.getXRot() != 0.0f && Math.abs((float)this.dolphin.getXRot()) < 10.0f && this.dolphin.isInWater() || this.dolphin.isOnGround());
    }
