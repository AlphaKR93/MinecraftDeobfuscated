...
extends MoveToBlockGoal {
    ...
    private BlockPos getPosWithBlock(BlockPos $$0, BlockGetter $$1) {
        ...
        for (BlockPos $$3 : $$2 = new BlockPos[]{$$0.below(), $$0.west(), $$0.east(), $$0.north(), $$0.south(), ((BlockPos)$$0.below()).below()}) {
    ...
    protected boolean isValidTarget(LevelReader $$0, BlockPos $$1) {
        ...
        if ($$2 != null) {
            return $$2.getBlockState($$1).is(this.blockToRemove) && $$2.getBlockState((BlockPos)$$1.above()).isAir() && $$2.getBlockState((BlockPos)$$1.above(2)).isAir();
        }
        return false;
    }
}