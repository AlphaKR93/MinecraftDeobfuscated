...
public abstract class PathNavigation {
    ...
    public PathNavigation(Mob $$0, Level $$1) {
        this.mob = $$0;
        this.level = $$1;
        int $$2 = Mth.floor($$0.getAttributeValue(Attributes.FOLLOW_RANGE) * 16.0);
    ...
    public final Path createPath(double $$0, double $$1, double $$2, int $$3) {
        return this.createPath(new BlockPos($$0, $$1, $$2), $$3);
    }

    @Nullable
    public Path createPath(Stream<BlockPos> $$0, int $$1) {
        return this.createPath((Set<BlockPos>)((Set)$$0.collect(Collectors.toSet())), 8, false, $$1);
    }
    ...
    public Path createPath(BlockPos $$0, int $$1) {
        return this.createPath((Set<BlockPos>)ImmutableSet.of((Object)$$0), 8, false, $$1);
    }

    @Nullable
    public Path createPath(BlockPos $$0, int $$1, int $$2) {
        return this.createPath((Set<BlockPos>)ImmutableSet.of((Object)$$0), 8, false, $$1, $$2);
    }

    @Nullable
    public Path createPath(Entity $$0, int $$1) {
        return this.createPath((Set<BlockPos>)ImmutableSet.of((Object)$$0.blockPosition()), 16, true, $$1);
    }

    @Nullable
    protected Path createPath(Set<BlockPos> $$0, int $$1, boolean $$2, int $$3) {
        return this.createPath($$0, $$1, $$2, $$3, (float)this.mob.getAttributeValue(Attributes.FOLLOW_RANGE));
    }
    ...
    protected Path createPath(Set<BlockPos> $$0, int $$1, boolean $$2, int $$3, float $$4) {
        ...
        if (this.path != null && !this.path.isDone() && $$0.contains((Object)this.targetPos)) {
            return this.path;
        }
        this.level.getProfiler().push("pathfind");
        Vec3i $$5 = $$2 ? this.mob.blockPosition().above() : this.mob.blockPosition();
        int $$6 = (int)($$4 + (float)$$1);
        PathNavigationRegion $$7 = new PathNavigationRegion(this.level, ((BlockPos)$$5).offset(-$$6, -$$6, -$$6), ((BlockPos)$$5).offset($$6, $$6, $$6));
    ...
    public void tick() {
        ...
        if (this.canUpdatePath()) {
            ...
            if ($$0.y > $$1.y && !this.mob.isOnGround() && Mth.floor($$0.x) == Mth.floor($$1.x) && Mth.floor($$0.z) == Mth.floor($$1.z)) {
                this.path.advance();
            }
        }
    ...
    protected double getGroundY(Vec3 $$0) {
        BlockPos $$1 = new BlockPos($$0);
        return this.level.getBlockState((BlockPos)$$1.below()).isAir() ? $$0.y : WalkNodeEvaluator.getFloorLevel(this.level, $$1);
    }
    ...
    protected void followThePath() {
        ...
        double $$2 = Math.abs((double)(this.mob.getX() - ((double)$$1.getX() + 0.5)));
    ...
    public boolean isStableDestination(BlockPos $$0) {
        Vec3i $$1 = $$0.below();
        return this.level.getBlockState((BlockPos)$$1).isSolidRender(this.level, (BlockPos)$$1);
    }
