...
public class DismountHelper {
    ...
    public static boolean isBlockFloorValid(double $$0) {
        return !Double.isInfinite((double)$$0) && $$0 < 1.0;
    }
    ...
    public static double findCeilingFrom(BlockPos $$0, int $$1, Function<BlockPos, VoxelShape> $$2) {
        ...
        for (int $$4 = 0; $$4 < $$1; ++$$4) {
            VoxelShape $$5 = (VoxelShape)$$2.apply((Object)$$3);
            if (!$$5.isEmpty()) {
    ...
    public static Vec3 findSafeDismountLocation(EntityType<?> $$0, CollisionGetter $$1, BlockPos $$2, boolean $$3) {
        ...
        double $$4 = $$1.getBlockFloorHeight(DismountHelper.nonClimbableShape($$1, $$2), () -> DismountHelper.nonClimbableShape($$1, (BlockPos)$$2.below()));
        if (!DismountHelper.isBlockFloorValid($$4)) {
            return null;
        }
        if ($$3 && $$4 <= 0.0 && $$0.isBlockDangerous($$1.getBlockState((BlockPos)$$2.below()))) {
            return null;
        }
        ...
        if ($$0 == EntityType.PLAYER && ($$1.getBlockState($$2).is(BlockTags.INVALID_SPAWN_INSIDE) || $$1.getBlockState((BlockPos)$$2.above()).is(BlockTags.INVALID_SPAWN_INSIDE))) {
            return null;
        }
