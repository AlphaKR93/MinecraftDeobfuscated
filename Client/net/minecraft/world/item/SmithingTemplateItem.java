...
extends Item {
    ...
    public SmithingTemplateItem(Component $$0, Component $$1, Component $$2, Component $$3, Component $$4, List<ResourceLocation> $$5, List<ResourceLocation> $$6) {
        ...
        this.appliesTo = $$0;
        this.ingredients = $$1;
        this.upgradeDescription = $$2;
        this.baseSlotDescription = $$3;
        this.additionsSlotDescription = $$4;
        this.baseSlotEmptyIcons = $$5;
        this.additionalSlotEmptyIcons = $$6;
    }

    public static SmithingTemplateItem createArmorTrimTemplate(ResourceKey<TrimPattern> $$0) {
        return SmithingTemplateItem.createArmorTrimTemplate($$0.location());
    }

    public static SmithingTemplateItem createArmorTrimTemplate(ResourceLocation $$0) {
        return new SmithingTemplateItem(ARMOR_TRIM_APPLIES_TO, ARMOR_TRIM_INGREDIENTS, Component.translatable(Util.makeDescriptionId("trim_pattern", $$0)).withStyle(TITLE_FORMAT), ARMOR_TRIM_BASE_SLOT_DESCRIPTION, ARMOR_TRIM_ADDITIONS_SLOT_DESCRIPTION, SmithingTemplateItem.createTrimmableArmorIconList(), SmithingTemplateItem.createTrimmableMaterialIconList());
    }
    ...
    private static List<ResourceLocation> createTrimmableMaterialIconList() {
        return List.of((Object)EMPTY_SLOT_INGOT, (Object)EMPTY_SLOT_REDSTONE_DUST, (Object)EMPTY_SLOT_LAPIS_LAZULI, (Object)EMPTY_SLOT_QUARTZ, (Object)EMPTY_SLOT_DIAMOND, (Object)EMPTY_SLOT_EMERALD);
    }
    ...
    public void appendHoverText(ItemStack $$0, @Nullable Level $$1, List<Component> $$2, TooltipFlag $$3) {
        ...
        $$2.add((Object)this.upgradeDescription);
        $$2.add((Object)CommonComponents.EMPTY);
        $$2.add((Object)APPLIES_TO_TITLE);
        $$2.add((Object)CommonComponents.space().append(this.appliesTo));
        $$2.add((Object)INGREDIENTS_TITLE);
        $$2.add((Object)CommonComponents.space().append(this.ingredients));
    }
