...
extends Feature<BlockColumnConfiguration> {
    ...
    public boolean place(FeaturePlaceContext<BlockColumnConfiguration> $$0) {
        ...
        int $$6 = 0;
        for (int $$7 = 0; $$7 < $$4; ++$$7) {
            $$5[$$7] = ((BlockColumnConfiguration.Layer)((Object)$$2.layers().get($$7))).height().sample($$3);
            $$6 += $$5[$$7];
        }
        if ($$6 == 0) {
            return false;
        ...
        for (int $$10 = 0; $$10 < $$6; ++$$10) {
            if (!$$2.allowedPlacement().test($$1, $$9)) {
                BlockColumnFeature.truncate($$5, $$6, $$10, $$2.prioritizeTip());
                break;
            }
            $$9.move($$2.direction());
        }
        for (int $$11 = 0; $$11 < $$4; ++$$11) {
            int $$12 = $$5[$$11];
            if ($$12 == 0) continue;
            BlockColumnConfiguration.Layer $$13 = (BlockColumnConfiguration.Layer)((Object)$$2.layers().get($$11));
