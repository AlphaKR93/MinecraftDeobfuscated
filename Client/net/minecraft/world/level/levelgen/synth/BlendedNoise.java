...
implements DensityFunction.SimpleFunction {
    ...
    public BlendedNoise(RandomSource $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
        this(PerlinNoise.createLegacyForBlendedNoise($$0, IntStream.rangeClosed((int)-15, (int)0)), PerlinNoise.createLegacyForBlendedNoise($$0, IntStream.rangeClosed((int)-15, (int)0)), PerlinNoise.createLegacyForBlendedNoise($$0, IntStream.rangeClosed((int)-7, (int)0)), $$1, $$2, $$3, $$4, $$5);
    }
    ...
    public void parityConfigString(StringBuilder $$0) {
        ...
        $$0.append(String.format((Locale)Locale.ROOT, (String)", xzScale=%.3f, yScale=%.3f, xzMainScale=%.3f, yMainScale=%.3f, cellWidth=4, cellHeight=8", (Object[])new Object[]{684.412, 684.412, 8.555150000000001, 4.277575000000001})).append('}');
    }
