...
extends ChunkGenerator {
    public static final Codec<DebugLevelSource> CODEC = RecordCodecBuilder.create($$0 -> $$0.group(RegistryOps.retrieveElement(Biomes.PLAINS)).apply((Applicative)$$0, $$0.stable(DebugLevelSource::new)));
    private static final int BLOCK_MARGIN = 2;
    private static final List<BlockState> ALL_BLOCKS = (List)StreamSupport.stream((Spliterator)BuiltInRegistries.BLOCK.spliterator(), (boolean)false).flatMap($$0 -> $$0.getStateDefinition().getPossibleStates().stream()).collect(Collectors.toList());
