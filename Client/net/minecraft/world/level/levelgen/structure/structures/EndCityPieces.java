...
public class EndCityPieces {
    ...
    static final SectionGenerator TOWER_GENERATOR = new SectionGenerator(){
        ...
        public boolean generate(StructureTemplateManager $$0, int $$1, EndCityPiece $$2, BlockPos $$3, List<StructurePiece> $$4, RandomSource $$5) {
            ...
            if ($$8 != null) {
                for (Tuple $$11 : TOWER_BRIDGES) {
                    if (!$$5.nextBoolean()) continue;
                    EndCityPiece $$12 = EndCityPieces.addHelper($$4, EndCityPieces.addPiece($$0, $$8, (BlockPos)$$11.getB(), "bridge_end", $$6.getRotated((Rotation)$$11.getA()), true));
    ...
    static final SectionGenerator FAT_TOWER_GENERATOR = new SectionGenerator(){
        ...
        public boolean generate(StructureTemplateManager $$0, int $$1, EndCityPiece $$2, BlockPos $$3, List<StructurePiece> $$4, RandomSource $$5) {
            ...
            for (int $$8 = 0; $$8 < 2 && $$5.nextInt(3) != 0; ++$$8) {
                ...
                for (Tuple $$9 : FAT_TOWER_BRIDGES) {
                    if (!$$5.nextBoolean()) continue;
                    EndCityPiece $$10 = EndCityPieces.addHelper($$4, EndCityPieces.addPiece($$0, $$7, (BlockPos)$$9.getB(), "bridge_end", $$6.getRotated((Rotation)$$9.getA()), true));
    ...
    static boolean recursiveChildren(StructureTemplateManager $$0, SectionGenerator $$1, int $$2, EndCityPiece $$3, BlockPos $$4, List<StructurePiece> $$5, RandomSource $$6) {
        ...
        if ($$1.generate($$0, $$2, $$3, $$4, (List<StructurePiece>)$$7, $$6)) {
            boolean $$8 = false;
            int $$9 = $$6.nextInt();
    ...
    extends TemplateStructurePiece {
        ...
        public EndCityPiece(StructureTemplateManager $$0, CompoundTag $$12) {
            super(StructurePieceType.END_CITY_PIECE, $$12, $$0, (Function<ResourceLocation, StructurePlaceSettings>)((Function)$$1 -> EndCityPiece.makeSettings($$12.getBoolean("OW"), Rotation.valueOf($$12.getString("Rot")))));
        }
        ...
        private static ResourceLocation makeResourceLocation(String $$0) {
            return new ResourceLocation("end_city/" + $$0);
        }
        ...
        protected void handleDataMarker(String $$0, BlockPos $$1, ServerLevelAccessor $$2, RandomSource $$3, BoundingBox $$4) {
            if ($$0.startsWith("Chest")) {
                Vec3i $$5 = $$1.below();
                if ($$4.isInside($$5)) {
                    RandomizableContainerBlockEntity.setLootTable($$2, $$3, (BlockPos)$$5, BuiltInLootTables.END_CITY_TREASURE);
                }
            } else if ($$4.isInside($$1) && Level.isInSpawnableBounds($$1)) {
                if ($$0.startsWith("Sentry")) {
                    Shulker $$6 = EntityType.SHULKER.create($$2.getLevel());
                    if ($$6 != null) {
