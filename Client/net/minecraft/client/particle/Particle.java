...
public abstract class Particle {
    ...
    public Particle(ClientLevel $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6) {
        ...
        double $$8 = Math.sqrt((double)(this.xd * this.xd + this.yd * this.yd + this.zd * this.zd));
    ...
    public void move(double $$0, double $$1, double $$2) {
        ...
        if (this.hasPhysics && ($$0 != 0.0 || $$1 != 0.0 || $$2 != 0.0) && $$0 * $$0 + $$1 * $$1 + $$2 * $$2 < MAXIMUM_COLLISION_VELOCITY_SQUARED) {
            Vec3 $$6 = Entity.collideBoundingBox(null, new Vec3($$0, $$1, $$2), this.getBoundingBox(), this.level, (List<VoxelShape>)List.of());
            $$0 = $$6.x;
            $$1 = $$6.y;
            $$2 = $$6.z;
        }
        ...
        if (Math.abs((double)$$4) >= (double)1.0E-5f && Math.abs((double)$$1) < (double)1.0E-5f) {
    ...
    protected int getLightColor(float $$0) {
        BlockPos $$1 = new BlockPos(this.x, this.y, this.z);
