...
extends Screen {
    ...
    private static final ImmutableList<StructureMode> DEFAULT_MODES = (ImmutableList)ALL_MODES.stream().filter($$0 -> $$0 != StructureMode.DATA).collect(ImmutableList.toImmutableList());
    ...
    public StructureBlockEditScreen(StructureBlockEntity $$0) {
        ...
        this.structure = $$0;
        this.decimalFormat.setDecimalFormatSymbols(DecimalFormatSymbols.getInstance((Locale)Locale.ROOT));
    }
    ...
    protected void init() {
        ...
        this.addRenderableWidget(CycleButton.builder($$0 -> Component.translatable("structure_block.mode." + $$0.getSerializedName())).withValues((List<StructureMode>)DEFAULT_MODES, (List<StructureMode>)ALL_MODES).displayOnlyValue().withInitialValue(this.initialMode).create(this.width / 2 - 4 - 150, 185, 50, 20, Component.literal("MODE"), ($$0, $$1) -> {
        ...
        this.mirrorButton = this.addRenderableWidget(CycleButton.builder(Mirror::symbol).withValues(Mirror.values()).displayOnlyValue().withInitialValue(this.initialMirror).create(this.width / 2 - 20, 185, 40, 20, Component.literal("MIRROR"), ($$0, $$1) -> this.structure.setMirror((Mirror)$$1)));
        ...
        this.nameEdit = new EditBox(this.font, this.width / 2 - 152, 40, 300, 20, (Component)Component.translatable("structure_block.structure_name")){
            ...
            public boolean charTyped(char $$0, int $$1) {
                if (!StructureBlockEditScreen.this.isValidCharacterForName(this.getValue(), $$0, this.getCursorPosition())) {
                    return false;
                }
        ...
        this.posXEdit.setValue(Integer.toString((int)$$02.getX()));
        ...
        this.posYEdit.setValue(Integer.toString((int)$$02.getY()));
        ...
        this.posZEdit.setValue(Integer.toString((int)$$02.getZ()));
        ...
        this.sizeXEdit.setValue(Integer.toString((int)$$12.getX()));
        ...
        this.sizeYEdit.setValue(Integer.toString((int)$$12.getY()));
        ...
        this.sizeZEdit.setValue(Integer.toString((int)$$12.getZ()));
        ...
        this.seedEdit.setValue(Long.toString((long)this.structure.getSeed()));
    ...
    private float parseIntegrity(String $$0) {
        try {
            return Float.valueOf((String)$$0).floatValue();
        }
        catch (NumberFormatException $$1) {
            return 1.0f;
        }
    ...
    public void render(PoseStack $$0, int $$1, int $$2, float $$3) {
        ...
        StructureBlockEditScreen.drawCenteredString($$0, this.font, this.title, this.width / 2, 10, 0xFFFFFF);
        if ($$4 != StructureMode.DATA) {
            StructureBlockEditScreen.drawString($$0, this.font, NAME_LABEL, this.width / 2 - 153, 30, 0xA0A0A0);
            this.nameEdit.render($$0, $$1, $$2, $$3);
        }
        if ($$4 == StructureMode.LOAD || $$4 == StructureMode.SAVE) {
            StructureBlockEditScreen.drawString($$0, this.font, POSITION_LABEL, this.width / 2 - 153, 70, 0xA0A0A0);
            this.posXEdit.render($$0, $$1, $$2, $$3);
            this.posYEdit.render($$0, $$1, $$2, $$3);
            this.posZEdit.render($$0, $$1, $$2, $$3);
            StructureBlockEditScreen.drawString($$0, this.font, INCLUDE_ENTITIES_LABEL, this.width / 2 + 154 - this.font.width(INCLUDE_ENTITIES_LABEL), 150, 0xA0A0A0);
        }
        if ($$4 == StructureMode.SAVE) {
            StructureBlockEditScreen.drawString($$0, this.font, SIZE_LABEL, this.width / 2 - 153, 110, 0xA0A0A0);
            this.sizeXEdit.render($$0, $$1, $$2, $$3);
            this.sizeYEdit.render($$0, $$1, $$2, $$3);
            this.sizeZEdit.render($$0, $$1, $$2, $$3);
            StructureBlockEditScreen.drawString($$0, this.font, DETECT_SIZE_LABEL, this.width / 2 + 154 - this.font.width(DETECT_SIZE_LABEL), 110, 0xA0A0A0);
            StructureBlockEditScreen.drawString($$0, this.font, SHOW_AIR_LABEL, this.width / 2 + 154 - this.font.width(SHOW_AIR_LABEL), 70, 0xA0A0A0);
        }
        if ($$4 == StructureMode.LOAD) {
            StructureBlockEditScreen.drawString($$0, this.font, INTEGRITY_LABEL, this.width / 2 - 153, 110, 0xA0A0A0);
            this.integrityEdit.render($$0, $$1, $$2, $$3);
            this.seedEdit.render($$0, $$1, $$2, $$3);
            StructureBlockEditScreen.drawString($$0, this.font, SHOW_BOUNDING_BOX_LABEL, this.width / 2 + 154 - this.font.width(SHOW_BOUNDING_BOX_LABEL), 70, 0xA0A0A0);
        }
        if ($$4 == StructureMode.DATA) {
            StructureBlockEditScreen.drawString($$0, this.font, CUSTOM_DATA_LABEL, this.width / 2 - 153, 110, 0xA0A0A0);
            this.dataEdit.render($$0, $$1, $$2, $$3);
        }
        StructureBlockEditScreen.drawString($$0, this.font, $$4.getDisplayName(), this.width / 2 - 153, 174, 0xA0A0A0);
