...
extends Screen {
    ...
    protected void init() {
        ...
        this.exitButtons.add((Object)this.addRenderableWidget(Button.builder($$02, $$0 -> this.minecraft.player.respawn()).bounds(this.width / 2 - 100, this.height / 4 + 72, 200, 20).build()));
