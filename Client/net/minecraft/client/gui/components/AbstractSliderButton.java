...
extends AbstractWidget {
    ...
    protected void renderBg(PoseStack $$0, Minecraft $$1, int $$2, int $$3) {
        ...
        int $$4 = (this.isHoveredOrFocused() ? 2 : 1) * 20;
        this.blit($$0, this.getX() + (int)(this.value * (double)(this.width - 8)), this.getY(), 0, 46 + $$4, 4, 20);
        this.blit($$0, this.getX() + (int)(this.value * (double)(this.width - 8)) + 4, this.getY(), 196, 46 + $$4, 4, 20);
    }
