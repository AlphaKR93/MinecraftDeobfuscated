...
public class TreeNodePosition {
    ...
    public TreeNodePosition(Advancement $$0, @Nullable TreeNodePosition $$1, @Nullable TreeNodePosition $$2, int $$3, int $$4) {
        ...
        for (Advancement $$6 : $$0.getChildren()) {
            $$5 = this.addChild($$6, $$5);
        }
    }

    @Nullable
    private TreeNodePosition addChild(Advancement $$0, @Nullable TreeNodePosition $$1) {
        if ($$0.getDisplay() != null) {
            $$1 = new TreeNodePosition($$0, this, $$1, this.children.size() + 1, this.x + 1);
            this.children.add((Object)$$1);
        } else {
    ...
    private void firstWalk() {
        ...
        this.executeShifts();
        float $$2 = (((TreeNodePosition)this.children.get((int)0)).y + ((TreeNodePosition)this.children.get((int)(this.children.size() - 1))).y) / 2.0f;
    ...
    private TreeNodePosition getAncestor(TreeNodePosition $$0, TreeNodePosition $$1) {
        if (this.ancestor != null && $$0.parent.children.contains((Object)this.ancestor)) {
    ...
    public static void run(Advancement $$0) {
        if ($$0.getDisplay() == null) {
