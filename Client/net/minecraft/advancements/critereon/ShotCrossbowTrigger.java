...
extends SimpleCriterionTrigger<TriggerInstance> {
    ...
    extends AbstractCriterionTriggerInstance {
        ...
        public static TriggerInstance shotCrossbow(ItemPredicate $$0) {
            return new TriggerInstance(EntityPredicate.Composite.ANY, $$0);
        }

        public static TriggerInstance shotCrossbow(ItemLike $$0) {
            return new TriggerInstance(EntityPredicate.Composite.ANY, ItemPredicate.Builder.item().of($$0).build());
        }
