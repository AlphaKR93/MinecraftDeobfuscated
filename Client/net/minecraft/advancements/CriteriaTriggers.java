...
public class CriteriaTriggers {
    ...
    private static <T extends CriterionTrigger<?>> T register(T $$0) {
        if (CRITERIA.containsKey((Object)$$0.getId())) {
            throw new IllegalArgumentException("Duplicate criterion id " + $$0.getId());
        }
        CRITERIA.put((Object)$$0.getId(), $$0);
        return $$0;
    }

    @Nullable
    public static <T extends CriterionTriggerInstance> CriterionTrigger<T> getCriterion(ResourceLocation $$0) {
        return (CriterionTrigger)CRITERIA.get((Object)$$0);
    }
