...
implements AutoCloseable {
    ...
    public static DirectoryLock create(Path $$0) throws IOException {
        ...
        FileChannel $$2 = FileChannel.open((Path)$$1, (OpenOption[])new OpenOption[]{StandardOpenOption.CREATE, StandardOpenOption.WRITE});
        try {
    ...
    public static boolean isLocked(Path $$0) throws IOException {
        Path $$1 = $$0.resolve(LOCK_FILE);
        try (FileChannel $$2 = FileChannel.open((Path)$$1, (OpenOption[])new OpenOption[]{StandardOpenOption.WRITE});){
            boolean bl;
            block15: {
                FileLock $$3 = $$2.tryLock();
                try {
    ...
    static {
        ...
        DUMMY = ByteBuffer.allocateDirect((int)$$0.length);
        DUMMY.put($$0);
        DUMMY.flip();
    }
