...
public class StringDecomposer {
    ...
    private static final Optional<Object> STOP_ITERATION = Optional.of((Object)((Object)Unit.INSTANCE));

    private static boolean feedChar(Style $$0, FormattedCharSink $$1, int $$2, char $$3) {
        if (Character.isSurrogate((char)$$3)) {
    ...
    public static boolean iterate(String $$0, Style $$1, FormattedCharSink $$2) {
        ...
        for (int $$4 = 0; $$4 < $$3; ++$$4) {
            char $$5 = $$0.charAt($$4);
            if (Character.isHighSurrogate((char)$$5)) {
                if ($$4 + 1 >= $$3) {
                    if ($$2.accept($$4, $$1, 65533)) break;
                    return false;
                }
                char $$6 = $$0.charAt($$4 + 1);
                if (Character.isLowSurrogate((char)$$6)) {
                    if (!$$2.accept($$4, $$1, Character.toCodePoint((char)$$5, (char)$$6))) {
                        return false;
                    }
                    ++$$4;
                    continue;
            ...
            if (StringDecomposer.feedChar($$1, $$2, $$4, $$5)) continue;
            return false;
        }
        return true;
    }
    ...
    public static boolean iterateBackwards(String $$0, Style $$1, FormattedCharSink $$2) {
        ...
        for (int $$4 = $$3 - 1; $$4 >= 0; --$$4) {
            char $$5 = $$0.charAt($$4);
            if (Character.isLowSurrogate((char)$$5)) {
                if ($$4 - 1 < 0) {
                    if ($$2.accept(0, $$1, 65533)) break;
                    return false;
                }
                char $$6 = $$0.charAt($$4 - 1);
                if (!(Character.isHighSurrogate((char)$$6) ? !$$2.accept(--$$4, $$1, Character.toCodePoint((char)$$6, (char)$$5)) : !$$2.accept($$4, $$1, 65533))) continue;
                return false;
            }
            if (StringDecomposer.feedChar($$1, $$2, $$4, $$5)) continue;
            return false;
    ...
    public static boolean iterateFormatted(String $$0, int $$1, Style $$2, Style $$3, FormattedCharSink $$4) {
        ...
        for (int $$7 = $$1; $$7 < $$5; ++$$7) {
            ...
            if (Character.isHighSurrogate((char)$$8)) {
                if ($$7 + 1 >= $$5) {
                    if ($$4.accept($$7, $$6, 65533)) break;
                    return false;
                }
                char $$11 = $$0.charAt($$7 + 1);
                if (Character.isLowSurrogate((char)$$11)) {
                    if (!$$4.accept($$7, $$6, Character.toCodePoint((char)$$8, (char)$$11))) {
                        return false;
                    }
                    ++$$7;
                    continue;
            ...
            if (StringDecomposer.feedChar($$6, $$4, $$7, $$8)) continue;
            return false;
        }
        return true;
    }
    ...
    public static boolean iterateFormatted(FormattedText $$0, Style $$12, FormattedCharSink $$22) {
        return !$$0.visit(($$1, $$2) -> StringDecomposer.iterateFormatted($$2, 0, $$1, $$22) ? Optional.empty() : STOP_ITERATION, $$12).isPresent();
    }
