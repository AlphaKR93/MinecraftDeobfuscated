...
public class MetricSampler {
    ...
    private void verifyRunning() {
        if (!this.isRunning) {
            throw new IllegalStateException(String.format((Locale)Locale.ROOT, (String)"Sampler for metric %s not started!", (Object[])new Object[]{this.name}));
        }
    }
    ...
    public boolean equals(Object $$0) {
        ...
        return this.name.equals((Object)$$1.name) && this.category.equals((Object)$$1.category);
    }
