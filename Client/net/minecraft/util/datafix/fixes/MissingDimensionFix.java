...
extends DataFix {
    ...
    protected TypeRewriteRule makeRule() {
        ...
        TaggedChoice.TaggedChoiceType $$1 = new TaggedChoice.TaggedChoiceType("type", DSL.string(), (Map)ImmutableMap.of((Object)"minecraft:debug", (Object)DSL.remainderType(), (Object)"minecraft:flat", MissingDimensionFix.flatType($$0), (Object)"minecraft:noise", MissingDimensionFix.optionalFields("biome_source", DSL.taggedChoiceType((String)"type", (Type)DSL.string(), (Map)ImmutableMap.of((Object)"minecraft:fixed", MissingDimensionFix.fields("biome", $$0.getType(References.BIOME)), (Object)"minecraft:multi_noise", (Object)DSL.list(MissingDimensionFix.fields("biome", $$0.getType(References.BIOME))), (Object)"minecraft:checkerboard", MissingDimensionFix.fields("biomes", DSL.list((Type)$$0.getType(References.BIOME))), (Object)"minecraft:vanilla_layered", (Object)DSL.remainderType(), (Object)"minecraft:the_end", (Object)DSL.remainderType())), "settings", DSL.or((Type)DSL.string(), MissingDimensionFix.optionalFields("default_block", $$0.getType(References.BLOCK_NAME), "default_fluid", $$0.getType(References.BLOCK_NAME))))));
        ...
        return this.fixTypeEverywhereTyped("MissingDimensionFix", $$4, $$32 -> $$32.updateTyped((OpticFinder)$$5, $$3 -> $$3.updateTyped($$6, $$2 -> {
            ...
            if (((List)$$2.getValue()).isEmpty()) {
                ...
                return (Typed)DataFixUtils.orElse((Optional)$$2.readTyped($$4).result().map(Pair::getFirst), (Object)$$2);
            }
            return $$2;
        })));
    }
