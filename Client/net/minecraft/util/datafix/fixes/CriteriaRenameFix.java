...
extends DataFix {
    ...
    private Dynamic<?> fixAdvancements(Dynamic<?> $$0) {
        return $$0.update(this.advancementId, $$02 -> $$02.update("criteria", $$0 -> $$0.updateMapValues($$02 -> $$02.mapFirst($$0 -> (Dynamic)DataFixUtils.orElse((Optional)$$0.asString().map($$1 -> $$0.createString((String)this.conversions.apply($$1))).result(), (Object)$$0)))));
    }
}