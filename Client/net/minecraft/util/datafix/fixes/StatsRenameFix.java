...
extends DataFix {
    ...
    private TypeRewriteRule createCriteriaRule() {
        ...
        Type $$4 = (Type)$$32.types().get((Object)"minecraft:custom");
        if ($$4 == null) {
        ...
        return this.fixTypeEverywhereTyped(this.name, $$1, $$0, $$3 -> $$3.updateTyped($$2, $$2 -> $$2.updateTyped($$5, $$1 -> $$1.update($$6, $$0 -> (String)this.renames.getOrDefault($$0, $$0)))));
    }
    ...
    private TypeRewriteRule createStatRule() {
        ...
        return this.fixTypeEverywhereTyped(this.name, $$1, $$0, $$3 -> $$3.updateTyped($$2, $$2 -> $$2.updateTyped($$32, $$1 -> $$1.update($$4, $$0 -> (String)this.renames.getOrDefault($$0, $$0)))));
    }
}