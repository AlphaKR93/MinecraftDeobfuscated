...
extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        return this.fixTypeEverywhereTyped("OptionsKeyLwjgl3Fix", this.getInputSchema().getType(References.OPTIONS), $$02 -> $$02.update(DSL.remainderFinder(), $$0 -> (Dynamic)$$0.getMapValues().map($$1 -> $$0.createMap((Map)$$1.entrySet().stream().map($$0 -> {
            if (((Dynamic)$$0.getKey()).asString("").startsWith("key_")) {
                Object $$1 = Integer.parseInt((String)((Dynamic)$$0.getValue()).asString(""));
                if ($$1 < 0) {
                    String $$6;
                    int $$2 = $$1 + 100;
                    if ($$2 == 0) {
