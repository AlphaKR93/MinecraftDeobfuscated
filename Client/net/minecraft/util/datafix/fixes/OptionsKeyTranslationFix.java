...
extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        return this.fixTypeEverywhereTyped("OptionsKeyTranslationFix", this.getInputSchema().getType(References.OPTIONS), $$02 -> $$02.update(DSL.remainderFinder(), $$0 -> (Dynamic)$$0.getMapValues().map($$12 -> $$0.createMap((Map)$$12.entrySet().stream().map($$1 -> {
            String $$2;
