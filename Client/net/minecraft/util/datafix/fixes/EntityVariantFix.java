...
extends NamedEntityFix {
    ...
    private static <T> Dynamic<T> updateAndRename(Dynamic<T> $$0, String $$1, String $$2, Function<Dynamic<T>, Dynamic<T>> $$3) {
        return $$0.map($$42 -> {
            ...
            Function $$6 = $$2 -> ((Dynamic)$$3.apply((Object)new Dynamic($$5, $$2))).getValue();
    ...
    protected Typed<?> fix(Typed<?> $$0) {
        return $$0.update(DSL.remainderFinder(), $$02 -> EntityVariantFix.updateAndRename($$02, this.fieldName, "variant", $$0 -> (Dynamic)DataFixUtils.orElse((Optional)$$0.asNumber().map($$1 -> $$0.createString((String)this.idConversions.apply($$1.intValue()))).result(), (Object)$$0)));
    }
}