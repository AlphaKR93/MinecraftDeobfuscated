...
extends DataFix {
    ...
    protected TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped(NAME, $$0, $$42, $$4 -> $$4.updateTyped($$1, $$5, $$3 -> {
            ...
            OptionalDynamic $$5 = ((Dynamic)$$4.get(DSL.remainderFinder())).get(DATAFIXER_CONTEXT_TAG);
            String $$6 = (String)$$5.get("dimension").asString().result().orElse((Object)"");
            String $$7 = (String)$$5.get("generator").asString().result().orElse((Object)"");
            boolean $$8 = "minecraft:overworld".equals((Object)$$6);
            MutableBoolean $$9 = new MutableBoolean();
            int $$10 = $$8 ? -4 : 0;
            Dynamic<?>[] $$11 = ChunkHeightAndBiomeFix.getBiomeContainers($$4, $$8, $$10, $$9);
            Dynamic<?> $$12 = ChunkHeightAndBiomeFix.makePalettedContainer($$4.createList(Stream.of((Object)$$4.createMap((Map)ImmutableMap.of((Object)$$4.createString("Name"), (Object)$$4.createString("minecraft:air"))))));
            HashSet $$13 = Sets.newHashSet();
            MutableObject $$14 = new MutableObject(() -> null);
            $$3 = $$3.updateTyped($$2, $$6, arg_0 -> ChunkHeightAndBiomeFix.lambda$makeRule$8((Set)$$13, $$12, $$10, $$11, $$14, $$4, $$6, arg_0));
            return $$3.update(DSL.remainderFinder(), arg_0 -> this.lambda$makeRule$9($$8, (Set)$$13, $$9, $$7, $$14, arg_0));
        }));
    }
    ...
    private Dynamic<?> predictChunkStatusBeforeSurface(Dynamic<?> $$0, Set<String> $$12) {
        return $$0.update("Status", $$1 -> {
            ...
            if (STATUS_IS_OR_AFTER_SURFACE.contains((Object)$$2)) {
                return $$1;
            }
            $$12.remove((Object)"minecraft:air");
            ...
            if ("noise".equals((Object)$$2) || $$3) {
                return $$1.createString("noise");
            }
            if ("biomes".equals((Object)$$2)) {
    ...
    private static Dynamic<?>[] getBiomeContainers(Dynamic<?> $$0, boolean $$12, int $$22, MutableBoolean $$3) {
        ...
        if ($$5 != null && $$5.length == 1536) {
            ...
            for (int $$6 = 0; $$6 < 24; ++$$6) {
                int $$7 = $$6;
                $$4[$$6] = ChunkHeightAndBiomeFix.makeBiomeContainer($$0, $$2 -> ChunkHeightAndBiomeFix.getOldBiome($$5, $$7 * 64 + $$2));
            }
            ...
            while ($$8 < 16) {
                int $$9 = $$8 - $$22;
                int $$10 = $$8++;
                $$4[$$9] = ChunkHeightAndBiomeFix.makeBiomeContainer($$0, $$2 -> ChunkHeightAndBiomeFix.getOldBiome($$5, $$10 * 64 + $$2));
            }
            if ($$12) {
                Dynamic<?> $$11 = ChunkHeightAndBiomeFix.makeBiomeContainer($$0, $$1 -> ChunkHeightAndBiomeFix.getOldBiome($$5, $$1 % 16));
                Dynamic<?> $$122 = ChunkHeightAndBiomeFix.makeBiomeContainer($$0, $$1 -> ChunkHeightAndBiomeFix.getOldBiome($$5, $$1 % 16 + 1008));
            ...
            Arrays.fill((Object[])$$4, ChunkHeightAndBiomeFix.makePalettedContainer($$0.createList(Stream.of((Object)$$0.createString(DEFAULT_BIOME)))));
        }
        return $$4;
    }
    ...
    private static Dynamic<?> updateChunkTag(Dynamic<?> $$0, boolean $$1, boolean $$2, boolean $$3, Supplier<ChunkProtoTickListFix.PoorMansPalettedContainer> $$4) {
        ...
        $$0 = ChunkHeightAndBiomeFix.addPaddingEntries($$0, "Lights");
        ...
        if ($$5.isPresent() && !"empty".equals((Object)($$7 = ($$6 = (Dynamic)$$5.get()).asString("")))) {
            $$0 = $$0.set("blending_data", $$0.createMap((Map)ImmutableMap.of((Object)$$0.createString("old_noise"), (Object)$$0.createBoolean(STATUS_IS_OR_AFTER_NOISE.contains((Object)$$7)))));
            ...
            if ($$8 != null) {
                ...
                boolean $$10 = $$7.equals((Object)"noise");
                for (int $$11 = 0; $$11 < 16; ++$$11) {
                    for (int $$12 = 0; $$12 < 16; ++$$12) {
                        boolean $$15;
                        Dynamic<?> $$13 = $$8.get($$12, 0, $$11);
                        boolean $$14 = $$13 != null && "minecraft:bedrock".equals((Object)$$13.get("Name").asString(""));
                        boolean bl = $$15 = $$13 != null && "minecraft:air".equals((Object)$$13.get("Name").asString(""));
                        if ($$15) {
                            $$9.set($$11 * 16 + $$12);
                        }
                        $$10 |= $$14;
                ...
                if ($$10 && $$9.cardinality() != $$9.size()) {
                    Dynamic $$16 = "full".equals((Object)$$7) ? $$0.createString("heightmaps") : $$6;
                    $$0 = $$0.set("below_zero_retrogen", $$0.createMap((Map)ImmutableMap.of((Object)$$0.createString("target_status"), (Object)$$16, (Object)$$0.createString("missing_bedrock"), (Object)$$0.createLongList(LongStream.of((long[])$$9.toLongArray())))));
    ...
    private static <T> Dynamic<T> shiftUpgradeData(Dynamic<T> $$02) {
        return $$02.update("Indices", $$0 -> {
            ...
            $$0.getMapValues().result().ifPresent(arg_0 -> ChunkHeightAndBiomeFix.lambda$shiftUpgradeData$19((Map)$$1, arg_0));
            return $$0.createMap((Map)$$1);
        });
    }
    ...
    private static Dynamic<?> updateCarvingMasks(Dynamic<?> $$0, int $$1, int $$2) {
        ...
        $$32 = $$32.updateMapValues($$3 -> {
            long[] $$4 = BitSet.valueOf((byte[])((Dynamic)$$3.getSecond()).asByteBuffer().array()).toLongArray();
            long[] $$5 = new long[64 * $$1];
            System.arraycopy((Object)$$4, (int)0, (Object)$$5, (int)(64 * $$2), (int)$$4.length);
            return Pair.of((Object)((Dynamic)$$3.getFirst()), (Object)$$0.createLongList(LongStream.of((long[])$$5)));
        });
        return $$0.set("CarvingMasks", $$32);
    }

    private static Dynamic<?> addPaddingEntries(Dynamic<?> $$0, String $$1) {
        List $$2 = (List)$$0.get($$1).orElseEmptyList().asStream().collect(Collectors.toCollection(ArrayList::new));
        if ($$2.size() == 24) {
            return $$0;
        }
        ...
        return $$02.createLongList($$02.asLongStream().map($$0 -> {
            ...
            while ($$2 + 9 <= 64) {
                ...
                if ($$3 == 0L) {
                    ...
                    $$5 = Math.min((long)($$3 + 64L), (long)511L);
                }
                $$1 |= $$5 << $$2;
                $$2 += 9;
            }
    ...
    private static Dynamic<?> makeBiomeContainer(Dynamic<?> $$0, Int2IntFunction $$12) {
        ...
        Dynamic $$14 = $$0.createLongList(Arrays.stream((long[])$$9));
    ...
    private static Dynamic<?> makeOptimizedPalettedContainer(Dynamic<?> $$0, Dynamic<?> $$1) {
        List $$2 = (List)$$0.asStream().collect(Collectors.toCollection(ArrayList::new));
        if ($$2.size() == 1) {
    ...
    public static int ceillog2(int $$0) {
        ...
        return (int)Math.ceil((double)(Math.log((double)$$0) / Math.log((double)2.0)));
    }

    private static /* synthetic */ void lambda$shiftUpgradeData$19(Map $$0, Map $$12) {
        $$12.forEach(($$1, $$2) -> {
            try {
                $$1.asString().result().map(Integer::parseInt).ifPresent($$3 -> {
                    int $$4 = $$3 - -4;
                    $$0.put((Object)$$1.createString(Integer.toString((int)$$4)), $$2);
                });
            }
    ...
    private /* synthetic */ Dynamic lambda$makeRule$9(boolean $$0, Set $$1, MutableBoolean $$2, String $$3, MutableObject $$4, Dynamic $$5) {
        if ($$0) {
            $$5 = this.predictChunkStatusBeforeSurface($$5, (Set<String>)$$1);
        }
        return ChunkHeightAndBiomeFix.updateChunkTag($$5, $$0, $$2.booleanValue(), "minecraft:noise".equals((Object)$$3), (Supplier<ChunkProtoTickListFix.PoorMansPalettedContainer>)((Supplier)$$4.getValue()));
    }

    private static /* synthetic */ Typed lambda$makeRule$8(Set $$0, Dynamic $$1, int $$2, Dynamic[] $$3, MutableObject $$4, Dynamic $$5, Type $$6, Typed $$7) {
        ...
        List $$10 = (List)$$9.asStream().map(arg_0 -> ChunkHeightAndBiomeFix.lambda$makeRule$6($$0, $$1, $$2, $$3, (IntSet)$$8, $$4, arg_0)).collect(Collectors.toCollection(ArrayList::new));
        for (int $$11 = 0; $$11 < $$3.length; ++$$11) {
            int $$12 = $$11 + $$2;
            if (!$$8.add($$12)) continue;
            Dynamic $$13 = $$5.createMap(Map.of((Object)$$5.createString("Y"), (Object)$$5.createInt($$12)));
            $$13 = $$13.set("block_states", $$1);
            $$13 = $$13.set("biomes", $$3[$$11]);
            $$10.add((Object)$$13);
        }
        return (Typed)((Pair)$$6.readTyped($$5.createList($$10.stream())).result().orElseThrow(() -> new IllegalStateException("ChunkHeightAndBiomeFix failed."))).getFirst();
    }

    private static /* synthetic */ Dynamic lambda$makeRule$6(Set $$0, Dynamic $$1, int $$22, Dynamic[] $$3, IntSet $$4, MutableObject $$5, Dynamic $$6) {
        int $$7 = $$6.get("Y").asInt(0);
        Dynamic $$8 = (Dynamic)DataFixUtils.orElse((Optional)$$6.get("Palette").result().flatMap($$2 -> {
            $$2.asStream().map($$0 -> $$0.get("Name").asString("minecraft:air")).forEach(arg_0 -> ((Set)$$0).add(arg_0));
