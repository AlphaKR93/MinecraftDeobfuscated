...
extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        OpticFinder $$12 = $$0.findField("Children");
        return this.fixTypeEverywhereTyped("ChunkStructuresTemplateRenameFix", $$0, $$1 -> $$1.updateTyped($$12, $$12 -> $$12.update(DSL.remainderFinder(), $$1 -> this.fixTag((Dynamic<?>)((Dynamic)$$1.get(DSL.remainderFinder())), (Dynamic<?>)$$1))));
    }

    private Dynamic<?> fixTag(Dynamic<?> $$0, Dynamic<?> $$1) {
        Pair $$3;
        String $$2 = $$0.get("id").asString("");
        if (RENAMES.containsKey((Object)$$2) && ((String)($$3 = (Pair)RENAMES.get((Object)$$2)).getFirst()).equals((Object)$$1.get("id").asString(""))) {
