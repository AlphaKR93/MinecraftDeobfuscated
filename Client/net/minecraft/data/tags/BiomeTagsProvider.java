...
extends TagsProvider<Biome> {
    ...
    protected void addTags(HolderLookup.Provider $$0) {
        ...
        HolderLookup.RegistryLookup<Biome> $$1 = $$0.lookupOrThrow(Registries.BIOME);
        TagsProvider.TagAppender<Biome> $$2 = this.tag(BiomeTags.IS_NETHER);
        MultiNoiseBiomeSource.Preset.NETHER.possibleBiomes($$1).forEach($$2::add);
        TagsProvider.TagAppender<Biome> $$3 = this.tag(BiomeTags.IS_OVERWORLD);
        MultiNoiseBiomeSource.Preset.OVERWORLD.possibleBiomes($$1).forEach($$3::add);
