...
public class SmithingTrimRecipeBuilder {
    ...
    public SmithingTrimRecipeBuilder(RecipeSerializer<?> $$0, RecipeCategory $$1, Ingredient $$2, Ingredient $$3, Ingredient $$4) {
        this.category = $$1;
        this.type = $$0;
        this.template = $$2;
        this.base = $$3;
    ...
    public static SmithingTrimRecipeBuilder smithingTrim(Ingredient $$0, Ingredient $$1, Ingredient $$2, RecipeCategory $$3) {
        return new SmithingTrimRecipeBuilder(RecipeSerializer.SMITHING_TRIM, $$3, $$0, $$1, $$2);
    }

    public SmithingTrimRecipeBuilder unlocks(String $$0, CriterionTriggerInstance $$1) {
    ...
    public void save(Consumer<FinishedRecipe> $$0, ResourceLocation $$1) {
        ...
        $$0.accept((Object)new Result($$1, this.type, this.template, this.base, this.addition, this.advancement, $$1.withPrefix("recipes/" + this.category.getFolderName() + "/")));
    }
