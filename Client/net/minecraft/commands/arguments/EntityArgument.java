...
implements ArgumentType<EntitySelector> {
    private static final Collection<String> EXAMPLES = Arrays.asList((Object[])new String[]{"Player", "0123", "@e", "@e[type=foo]", "dd12be42-52a9-4a91-a8a1-11c01849e498"});
    ...
    public EntitySelector parse(StringReader $$0) throws CommandSyntaxException {
        boolean $$1 = false;
        EntitySelectorParser $$2 = new EntitySelectorParser($$0);
    ...
    public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> $$0, SuggestionsBuilder $$12) {
        ...
        if (object instanceof SharedSuggestionProvider) {
            ...
            return $$4.fillSuggestions($$12, (Consumer<SuggestionsBuilder>)((Consumer)$$1 -> {
                Iterable $$2 = $$2.getOnlinePlayerNames();
                Iterable $$3 = this.playersOnly ? $$2 : Iterables.concat($$2, $$2.getSelectedEntities());
                SharedSuggestionProvider.suggest((Iterable<String>)$$3, $$1);
            }));
        }
