...
implements ArgumentType<Holder.Reference<T>> {
    ...
    private static final DynamicCommandExceptionType ERROR_NOT_SUMMONABLE_ENTITY = new DynamicCommandExceptionType($$0 -> Component.translatable("entity.not_summonable", $$0));
    public static final Dynamic2CommandExceptionType ERROR_UNKNOWN_RESOURCE = new Dynamic2CommandExceptionType(($$0, $$1) -> Component.translatable("argument.resource.not_found", $$0, $$1));
    public static final Dynamic3CommandExceptionType ERROR_INVALID_RESOURCE_TYPE = new Dynamic3CommandExceptionType(($$0, $$1, $$2) -> Component.translatable("argument.resource.invalid_type", $$0, $$1, $$2));
    ...
    public Holder.Reference<T> parse(StringReader $$0) throws CommandSyntaxException {
        ...
        return (Holder.Reference)this.registryLookup.get($$2).orElseThrow(() -> ERROR_UNKNOWN_RESOURCE.create((Object)$$1, (Object)this.registryKey.location()));
    }
