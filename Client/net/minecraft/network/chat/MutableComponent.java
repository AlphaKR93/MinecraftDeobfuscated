...
implements Component {
    ...
    public static MutableComponent create(ComponentContents $$0) {
        return new MutableComponent($$0, (List<Component>)Lists.newArrayList(), Style.EMPTY);
    }
    ...
    public MutableComponent append(Component $$0) {
        this.siblings.add((Object)$$0);
        return this;
    }

    public MutableComponent withStyle(UnaryOperator<Style> $$0) {
        this.setStyle((Style)$$0.apply((Object)this.getStyle()));
        return this;
    }
    ...
    public int hashCode() {
        return Objects.hash((Object[])new Object[]{this.contents, this.style, this.siblings});
    }
