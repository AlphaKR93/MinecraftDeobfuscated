...
public class WardenSpawnTrackerCommand {
    ...
    private static int setWarningLevel(CommandSourceStack $$0, Collection<? extends Player> $$12, int $$2) {
        ...
        if ($$12.size() == 1) {
            $$0.sendSuccess(Component.translatable("commands.warden_spawn_tracker.set.success.single", ((Player)((Object)$$12.iterator().next())).getDisplayName()), true);
        } else {
    ...
    private static int resetTracker(CommandSourceStack $$0, Collection<? extends Player> $$1) {
        ...
        if ($$1.size() == 1) {
            $$0.sendSuccess(Component.translatable("commands.warden_spawn_tracker.clear.success.single", ((Player)((Object)$$1.iterator().next())).getDisplayName()), true);
        } else {
