...
public class SaveAllCommand {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> $$02) {
        $$02.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("save-all").requires($$0 -> $$0.hasPermission(4))).executes($$0 -> SaveAllCommand.saveAll((CommandSourceStack)$$0.getSource(), false))).then(Commands.literal("flush").executes($$0 -> SaveAllCommand.saveAll((CommandSourceStack)$$0.getSource(), true))));
    }
