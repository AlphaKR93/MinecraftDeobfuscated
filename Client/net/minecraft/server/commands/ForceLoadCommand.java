...
public class ForceLoadCommand {
    ...
    private static final Dynamic2CommandExceptionType ERROR_TOO_MANY_CHUNKS = new Dynamic2CommandExceptionType(($$0, $$1) -> Component.translatable("commands.forceload.toobig", $$0, $$1));
    private static final Dynamic2CommandExceptionType ERROR_NOT_TICKING = new Dynamic2CommandExceptionType(($$0, $$1) -> Component.translatable("commands.forceload.query.failure", $$0, $$1));
    ...
    private static int queryForceLoad(CommandSourceStack $$0, ColumnPos $$1) throws CommandSyntaxException {
        ...
        if ($$5) {
            $$0.sendSuccess(Component.translatable("commands.forceload.query.success", $$2, $$4.location()), false);
            return 1;
        }
    ...
    private static int listForceLoad(CommandSourceStack $$0) {
        ...
        if ($$4 > 0) {
            ...
            if ($$4 == 1) {
                $$0.sendSuccess(Component.translatable("commands.forceload.list.single", $$2.location(), $$5), false);
            } else {
                $$0.sendSuccess(Component.translatable("commands.forceload.list.multiple", $$4, $$2.location(), $$5), false);
            }
        } else {
            $$0.sendFailure(Component.translatable("commands.forceload.added.none", $$2.location()));
        }
        return $$4;
    }
    ...
    private static int removeAll(CommandSourceStack $$0) {
        ...
        LongSet $$3 = $$12.getForcedChunks();
        $$3.forEach($$1 -> $$12.setChunkForced(ChunkPos.getX($$1), ChunkPos.getZ($$1), false));
        $$0.sendSuccess(Component.translatable("commands.forceload.removed.all", $$2.location()), true);
        return 0;
    }

    private static int changeForceLoad(CommandSourceStack $$0, ColumnPos $$1, ColumnPos $$2, boolean $$3) throws CommandSyntaxException {
        int $$11;
        int $$4 = Math.min((int)$$1.x(), (int)$$2.x());
        int $$5 = Math.min((int)$$1.z(), (int)$$2.z());
        int $$6 = Math.max((int)$$1.x(), (int)$$2.x());
        int $$7 = Math.max((int)$$1.z(), (int)$$2.z());
        ...
        if ($$16 == 1) {
            $$0.sendSuccess(Component.translatable("commands.forceload." + ($$3 ? "added" : "removed") + ".single", $$15, $$14.location()), true);
        } else {
            ChunkPos $$20 = new ChunkPos($$8, $$9);
            ChunkPos $$21 = new ChunkPos($$10, $$11);
            $$0.sendSuccess(Component.translatable("commands.forceload." + ($$3 ? "added" : "removed") + ".multiple", $$16, $$14.location(), $$20, $$21), true);
        }
        return $$16;
    }
}