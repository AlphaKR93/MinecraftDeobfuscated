...
public class PlaceCommand {
    ...
    private static final DynamicCommandExceptionType ERROR_TEMPLATE_INVALID = new DynamicCommandExceptionType($$0 -> Component.translatable("commands.place.template.invalid", $$0));
    ...
    public static int placeStructure(CommandSourceStack $$02, Holder.Reference<Structure> $$1, BlockPos $$2) throws CommandSyntaxException {
        ...
        StructureStart $$6 = $$4.generate($$02.registryAccess(), $$5, $$5.getBiomeSource(), $$32.getChunkSource().randomState(), $$32.getStructureManager(), $$32.getSeed(), new ChunkPos($$2), 0, $$32, (Predicate<Holder<Biome>>)((Predicate)$$0 -> true));
        if (!$$6.isValid()) {
        ...
        ChunkPos.rangeClosed($$8, $$9).forEach($$3 -> $$6.placeInChunk($$32, $$32.structureManager(), $$5, $$32.getRandom(), new BoundingBox($$3.getMinBlockX(), $$32.getMinBuildHeight(), $$3.getMinBlockZ(), $$3.getMaxBlockX(), $$32.getMaxBuildHeight(), $$3.getMaxBlockZ()), (ChunkPos)$$3));
        String $$10 = $$1.key().location().toString();
        $$02.sendSuccess(Component.translatable("commands.place.structure.success", $$10, $$2.getX(), $$2.getY(), $$2.getZ()), true);
        return 1;
    }
    ...
    public static int placeTemplate(CommandSourceStack $$0, ResourceLocation $$1, BlockPos $$2, Rotation $$3, Mirror $$4, float $$5, int $$6) throws CommandSyntaxException {
        ...
        try {
            Optional<StructureTemplate> $$9 = $$8.get($$1);
        }
        ...
        PlaceCommand.checkLoaded($$7, new ChunkPos($$2), new ChunkPos((BlockPos)$$2.offset($$12.getSize())));
        StructurePlaceSettings $$13 = new StructurePlaceSettings().setMirror($$4).setRotation($$3);
        if ($$5 < 1.0f) {
            $$13.clearProcessors().addProcessor(new BlockRotProcessor($$5)).setRandom(StructureBlockEntity.createRandom($$6));
        }
        if (!($$14 = $$12.placeInWorld($$7, $$2, $$2, $$13, StructureBlockEntity.createRandom($$6), 2))) {
            throw ERROR_TEMPLATE_FAILED.create();
        }
        $$0.sendSuccess(Component.translatable("commands.place.template.success", $$1, $$2.getX(), $$2.getY(), $$2.getZ()), true);
        return 1;
    }
