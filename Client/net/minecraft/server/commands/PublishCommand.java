...
public class PublishCommand {
    ...
    public static MutableComponent getSuccessMessage(int $$0) {
        MutableComponent $$1 = ComponentUtils.copyOnClickText(String.valueOf((int)$$0));
