...
public class OpenAlUtil {
    ...
    static boolean checkALCError(long $$0, String $$1) {
        ...
        if ($$2 != 0) {
            LOGGER.error("{}{}: {}", new Object[]{$$1, $$0, OpenAlUtil.alcErrorToString($$2)});
            return true;
        }
        return false;
    }
    ...
    static int audioFormatToOpenAl(AudioFormat $$0) {
        ...
        if ($$1.equals((Object)AudioFormat.Encoding.PCM_UNSIGNED) || $$1.equals((Object)AudioFormat.Encoding.PCM_SIGNED)) {
            if ($$2 == 1) {
                if ($$3 == 8) {
                    return 4352;
                }
