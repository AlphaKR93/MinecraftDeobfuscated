...
public class InputConstants {
    ...
    static {
        ...
        MethodType $$1 = MethodType.methodType((Class)Boolean.TYPE);
        MethodHandle $$2 = null;
        int $$3 = 0;
        try {
    ...
    public static enum Type {
        KEYSYM("key.keyboard", (BiFunction<Integer, String, Component>)((BiFunction)($$0, $$1) -> {
            String $$2 = GLFW.glfwGetKeyName((int)$$0, (int)-1);
            return $$2 != null ? Component.literal($$2) : Component.translatable($$1);
        })),
        SCANCODE("scancode", (BiFunction<Integer, String, Component>)((BiFunction)($$0, $$1) -> {
            String $$2 = GLFW.glfwGetKeyName((int)-1, (int)$$0);
            return $$2 != null ? Component.literal($$2) : Component.translatable($$1);
        })),
        MOUSE("key.mouse", (BiFunction<Integer, String, Component>)((BiFunction)($$0, $$1) -> Language.getInstance().has((String)$$1) ? Component.translatable($$1) : Component.translatable("key.mouse", $$0 + 1)));
    ...
    public static final class Key {
        ...
        Key(String $$0, Type $$1, int $$2) {
            ...
            this.type = $$1;
            this.value = $$2;
            this.displayName = new LazyLoadedValue(() -> (Component)$$0.displayTextSupplier.apply((Object)$$2, (Object)$$0));
            NAME_MAP.put((Object)$$0, (Object)this);
        }
        ...
        public OptionalInt getNumericKeyValue() {
            if (this.value >= 48 && this.value <= 57) {
                return OptionalInt.of((int)(this.value - 48));
            }
            if (this.value >= 320 && this.value <= 329) {
                return OptionalInt.of((int)(this.value - 320));
            }
        ...
        public int hashCode() {
            return Objects.hash((Object[])new Object[]{this.type, this.value});
        }
