    ...
    public static RealmsServerPlayerLists parse(String $$0) {
        ...
        try {
            ...
            if ($$3.get("lists").isJsonArray()) {
                ...
                while ($$5.hasNext()) {
                    $$1.servers.add((Object)RealmsServerPlayerList.parse(((JsonElement)$$5.next()).getAsJsonObject()));
                }
            }
        }
        catch (Exception $$6) {
            LOGGER.error("Could not parse RealmsServerPlayerLists: {}", (Object)$$6.getMessage());
        }
        return $$1;
    }
}